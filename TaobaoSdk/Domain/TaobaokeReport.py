...
from TaobaokeReportMember import TaobaokeReportMember

        
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">淘客API</SPAN>
class TaobaokeReport(object):
    def __init__(self, kargs=dict()):
        super(self.__class__, self).__init__()
        
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">淘宝客报表成员列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TaobaokeReportMember</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.taobaoke_report_members = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">搜索到的结果的总条数</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "taobaoke_report_members": "TaobaokeReportMember",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("taobaoke_report_members"):
            self.taobaoke_report_members = self._newInstance("taobaoke_report_members", kargs["taobaoke_report_members"])
