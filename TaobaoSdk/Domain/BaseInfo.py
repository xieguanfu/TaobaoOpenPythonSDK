...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">国内机票，订单基本信息数据结构【top订单优化】</SPAN>
class BaseInfo(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">买家支付宝帐号</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">订单出票方式==> 1:手工hk;2:自动出票;3:自动hk手工出票</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">佣金比率</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">订单淘宝唯一主键</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">关联订单号，普通往返另一程订单号，仅两程订单为同一个代理商时提供</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">航程类型：0，单程；1，普通往返；2，多程（暂时没有使用）；3，特价往返</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("account_no"):
            self.account_no = self._newInstance("account_no", kargs["account_no"])
        
        if kargs.has_key("alipay_trade_no"):
            self.alipay_trade_no = self._newInstance("alipay_trade_no", kargs["alipay_trade_no"])
        
        if kargs.has_key("book_way"):
            self.book_way = self._newInstance("book_way", kargs["book_way"])
        
        if kargs.has_key("commission"):
            self.commission = self._newInstance("commission", kargs["commission"])
        
        if kargs.has_key("commission_discount"):
            self.commission_discount = self._newInstance("commission_discount", kargs["commission_discount"])
        ...
        if kargs.has_key("relative_order_id"):
            self.relative_order_id = self._newInstance("relative_order_id", kargs["relative_order_id"])
