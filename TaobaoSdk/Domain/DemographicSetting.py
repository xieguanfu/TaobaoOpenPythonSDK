...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">投放人群设置</SPAN>
class DemographicSetting(object):
    def __init__(self, kargs=dict()):
        ...
        # </LI>
        # </UL>
        self.demographic_id = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">加价</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
    ...
    def _getPropertyType(self, name):
        ...
        levels = {
            ...
            "demographic_id": "Basic",
            
            "incremental_price": "Basic",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("demographic_id"):
            self.demographic_id = self._newInstance("demographic_id", kargs["demographic_id"])
        
        if kargs.has_key("incremental_price"):
            self.incremental_price = self._newInstance("incremental_price", kargs["incremental_price"])
