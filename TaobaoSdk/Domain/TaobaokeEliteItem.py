...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">淘宝客精品库商品</SPAN>
class TaobaokeEliteItem(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">商品折扣价</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">宝贝折扣率。8000代表80.00%</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否消费者保障。true：参与消费者保障</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.is_cust_assurance = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否7天退换货。true：参与7天退换货</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Boolean</SPAN>
        # </LI>
        ...
        # </LI>
        # </UL>
        self.is_exchange7 = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否正品保障。true：参与正品保障</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Boolean</SPAN>
        # </LI>
        ...
        # </LI>
        # </UL>
        self.is_item_assurance = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否24小时发货。true：参与24小时发货</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Boolean</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否免邮。true：参与免邮</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Boolean</SPAN>
        # </LI>
        ...
        # </LI>
        # </UL>
        self.is_postage_free = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">宝贝推广点击串url</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">邮费</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Price</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">30天成交量</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "is_cust_assurance": "Boolean",
            
            "is_exchange7": "Boolean",
            
            "is_item_assurance": "Boolean",
            
            "is_post24": "Boolean",
            
            "is_postage_free": "Boolean",
            
            "item_click_url": "String",
            ...
            "thirtyday_sales": "Number",
            
            "title": "String",
        }
        levels = {
            
            "discount_price": "Basic",
            
            "discount_rate": "Basic",
            
            "is_cust_assurance": "Basic",
            
            "is_exchange7": "Basic",
            
            "is_item_assurance": "Basic",
            
            "is_post24": "Basic",
            
            "is_postage_free": "Basic",
            
            "item_click_url": "Basic",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("discount_price"):
            self.discount_price = self._newInstance("discount_price", kargs["discount_price"])
        
        if kargs.has_key("discount_rate"):
            self.discount_rate = self._newInstance("discount_rate", kargs["discount_rate"])
        
        if kargs.has_key("is_cust_assurance"):
            self.is_cust_assurance = self._newInstance("is_cust_assurance", kargs["is_cust_assurance"])
        
        if kargs.has_key("is_exchange7"):
            self.is_exchange7 = self._newInstance("is_exchange7", kargs["is_exchange7"])
        
        if kargs.has_key("is_item_assurance"):
            self.is_item_assurance = self._newInstance("is_item_assurance", kargs["is_item_assurance"])
        
        if kargs.has_key("is_post24"):
            self.is_post24 = self._newInstance("is_post24", kargs["is_post24"])
        
        if kargs.has_key("is_postage_free"):
            self.is_postage_free = self._newInstance("is_postage_free", kargs["is_postage_free"])
        
        if kargs.has_key("item_click_url"):
            self.item_click_url = self._newInstance("item_click_url", kargs["item_click_url"])
        ...
        if kargs.has_key("thirtyday_sales"):
            self.thirtyday_sales = self._newInstance("thirtyday_sales", kargs["thirtyday_sales"])
