...
class ADGroup(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">商品类目id，从根类目到子类目，用空格分割</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">默认出价，单位为分，不能小于5</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">非搜索是否使用默认出价，false-不用；true-使用；默认为true;</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.is_nonsearch_default_price = None
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">推广组主人昵称</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">非搜索出价，单位为分，不能小于5</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">online-上线；audit_offline-审核下线；crm_offline-CRM下线；默认为online</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">用户设置的上下线状态，offline-下线(暂停竞价)；online-上线；默认为online</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">审核下线原因</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "is_nonsearch_default_price": "Boolean",
        ...
        levels = {
            ...
            "is_nonsearch_default_price": "Basic",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("category_ids"):
            self.category_ids = self._newInstance("category_ids", kargs["category_ids"])
        
        if kargs.has_key("create_time"):
            self.create_time = self._newInstance("create_time", kargs["create_time"])
        
        if kargs.has_key("default_price"):
            self.default_price = self._newInstance("default_price", kargs["default_price"])
        
        if kargs.has_key("is_nonsearch_default_price"):
            self.is_nonsearch_default_price = self._newInstance("is_nonsearch_default_price", kargs["is_nonsearch_default_price"])
        ...
        if kargs.has_key("offline_type"):
            self.offline_type = self._newInstance("offline_type", kargs["offline_type"])
        
        if kargs.has_key("online_status"):
            self.online_status = self._newInstance("online_status", kargs["online_status"])
