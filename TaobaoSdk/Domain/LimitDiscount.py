...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">限时打折</SPAN>
class LimitDiscount(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">该限时打折宝贝数量。</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">限时打折ID。</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
    ...
    def _getPropertyType(self, name):
        ...
        levels = {
            ...
            "limit_discount_id": "Basic",
            
            "limit_discount_name": "Basic",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("limit_discount_id"):
            self.limit_discount_id = self._newInstance("limit_discount_id", kargs["limit_discount_id"])
