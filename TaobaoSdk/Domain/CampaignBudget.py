...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">推广计划的日限额</SPAN>
class CampaignBudget(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">日限额，单位是元，不得小于30</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否平滑消耗，true-是；false-否；在设置了推广计划日限额后，此属性才生效</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("budget"):
            self.budget = self._newInstance("budget", kargs["budget"])
        ...
        if kargs.has_key("is_smooth"):
            self.is_smooth = self._newInstance("is_smooth", kargs["is_smooth"])
