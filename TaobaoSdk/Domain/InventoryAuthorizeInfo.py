...
class InventoryAuthorizeInfo(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">本次授权的授权结果码</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">渠道标记 1 – 16 淘宝保留 17- 32 商家定义</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.channel_flag = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">批量请求时列表的序号</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">库存类型 0-10 淘宝保留 11-20 商家自定义 1：普通良品 2：损坏 3：冻结 10：质押</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        # </LI>
        # </UL>
        self.nick_name_list = None
        
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">当前总共占用的库存数量</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">授权给其他用户的配额库存数量</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">商家仓编号</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>
    ...
    def _getPropertyType(self, name):
        ...
        levels = {
            ...
            "nick_name_list": "Basic",
            
            "occupy_quantity": "Basic",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("authorize_code"):
            self.authorize_code = self._newInstance("authorize_code", kargs["authorize_code"])
        
        if kargs.has_key("channel_flag"):
            self.channel_flag = self._newInstance("channel_flag", kargs["channel_flag"])
        
        if kargs.has_key("index"):
            self.index = self._newInstance("index", kargs["index"])
        
        if kargs.has_key("inventory_type"):
            self.inventory_type = self._newInstance("inventory_type", kargs["inventory_type"])
        
        if kargs.has_key("nick_name"):
            self.nick_name = self._newInstance("nick_name", kargs["nick_name"])
        
        if kargs.has_key("nick_name_list"):
            self.nick_name_list = self._newInstance("nick_name_list", kargs["nick_name_list"])
        
        if kargs.has_key("occupy_quantity"):
            self.occupy_quantity = self._newInstance("occupy_quantity", kargs["occupy_quantity"])
