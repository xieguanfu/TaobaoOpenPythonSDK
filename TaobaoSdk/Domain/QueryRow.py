...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">MBP查询结果行记录</SPAN>
class QueryRow(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">结果集中一行记录的各列结果</SPAN>
        # <UL>
        # <LI>
