...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">商品或店铺的信息</SPAN>
class CollectItem(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">被收藏宝贝或店铺所有者的昵称</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("item_owner_nick"):
            self.item_owner_nick = self._newInstance("item_owner_nick", kargs["item_owner_nick"])
