...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">物流宝订单，并且包含订单详情</SPAN>
class WlbOrderDetail(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">如果是交易单，则显示交易中买家昵称</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否已全部完成</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">订单最后一次修改时间</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Date</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="color:Blue3; font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">物流宝订单对应的商品详情</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">WlbOrderItem</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("is_completed"):
            self.is_completed = self._newInstance("is_completed", kargs["is_completed"])
        ...
        if kargs.has_key("order_item_list"):
            self.order_item_list = self._newInstance("order_item_list", kargs["order_item_list"])
