...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 对已经授权的配额账户进行配额数量的更改；</SPAN>
# <UL>
# </UL>
class InventoryAuthorizeUpdateResponse(object):
