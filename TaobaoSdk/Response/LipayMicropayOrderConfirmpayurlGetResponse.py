...
from Domain.SinglePayDetail import SinglePayDetail



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建并支付冻结单之后，使用此接口获取有密支付的url 这个接口调用的前提是创建冻结金的参数信息pay_confirm=PAY_PASSWORD</SPAN>
# <UL>
# </UL>
class LipayMicropayOrderConfirmpayurlGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">SinglePayDetail信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">SinglePayDetail</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "single_pay_detail": "SinglePayDetail",
        }
        levels = {
            
            "single_pay_detail": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("single_pay_detail"):
            self.single_pay_detail = self._newInstance("single_pay_detail", kargs["single_pay_detail"])
