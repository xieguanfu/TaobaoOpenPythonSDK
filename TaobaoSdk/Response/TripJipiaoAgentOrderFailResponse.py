...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 国内机票代理商失败订单接口</SPAN>
# <UL>
# </UL>
class TripJipiaoAgentOrderFailResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">失败订单操作成功失败</SPAN>
        # <UL>
        # <LI>
