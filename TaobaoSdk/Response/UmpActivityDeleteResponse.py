...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除营销活动。对应的活动详情等将会被全部删除。</SPAN>
# <UL>
# </UL>
class UmpActivityDeleteResponse(object):
