...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 产品分销商配额库存新增、修改、删除</SPAN>
# <UL>
# </UL>
class FenxiaoProductPduUpdateResponse(object):
