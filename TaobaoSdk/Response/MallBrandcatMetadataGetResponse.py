...
from Domain.BrandCatMetaData import BrandCatMetaData



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取指定叶子类目、品牌、商家的达尔文数据</SPAN>
# <UL>
# </UL>
class MallBrandcatMetadataGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">类目、品牌下的达尔文元数据</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">BrandCatMetaData</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "brand_cat_meta_data": "BrandCatMetaData",
        }
        levels = {
            
            "brand_cat_meta_data": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("brand_cat_meta_data"):
            self.brand_cat_meta_data = self._newInstance("brand_cat_meta_data", kargs["brand_cat_meta_data"])
