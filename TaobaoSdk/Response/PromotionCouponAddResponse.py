...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建店铺优惠券。有效期内的店铺优惠券总数量不超过200张</SPAN>
# <UL>
# </UL>
class PromotionCouponAddResponse(object):
