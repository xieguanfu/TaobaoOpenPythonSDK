...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除一个sku的数据 需要删除的sku通过属性properties进行匹配查找</SPAN>
# <UL>
# </UL>
class ItemSkuDeleteResponse(object):
