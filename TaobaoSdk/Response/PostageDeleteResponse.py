...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除单个邮费模板  postage_id对应的邮费模板要属于当前会话用户</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class PostageDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">邮费模板</SPAN>
        # <UL>
        # <LI>
        ...
        self.postage = None
        ''' 
        @ivar postage: 邮费模板; B{Level}: C{Object}; B{Required}: C{true}; B{Sample}: C{};
