...
from Domain.ADGroupCatMatchPage import ADGroupCatMatchPage



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获得更改过的推广组类目出价列表,此类表中只存类目出价ID和推广组ID</SPAN>
# <UL>
# </UL>
class SimbaAdgroupChangedcatmatchsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">一页类目出价对象</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ADGroupCatMatchPage</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "changed_catmatchs": "ADGroupCatMatchPage",
        }
        levels = {
            
            "changed_catmatchs": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("changed_catmatchs"):
            self.changed_catmatchs = self._newInstance("changed_catmatchs", kargs["changed_catmatchs"])
