...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据外部产品id，进行政策状态更新，挂起/解挂/删除</SPAN>
# <UL>
# </UL>
class JipiaoPolicystatusUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">机票政策状态更新结果，true，成功；false，失败</SPAN>
        # <UL>
        # <LI>
