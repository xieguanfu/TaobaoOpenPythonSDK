...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询退货单 或者 退款单数量</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundBillsumGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">总数</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("bill_sum"):
            self.bill_sum = self._newInstance("bill_sum", kargs["bill_sum"])
