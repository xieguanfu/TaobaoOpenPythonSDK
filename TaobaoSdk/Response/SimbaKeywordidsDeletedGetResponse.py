...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取删除的词ID</SPAN>
# <UL>
# </UL>
class SimbaKeywordidsDeletedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">词ID列表</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "deleted_keyword_ids": "Number",
        }
        levels = {
            
            "deleted_keyword_ids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("deleted_keyword_ids"):
            self.deleted_keyword_ids = self._newInstance("deleted_keyword_ids", kargs["deleted_keyword_ids"])
