...
from Domain.TakeoutThirdOrder import TakeoutThirdOrder



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取订单详情</SPAN>
# <UL>
# </UL>
class WaimaiOrderSingleGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">订单详情</SPAN>
        # <UL>
        # <LI>
