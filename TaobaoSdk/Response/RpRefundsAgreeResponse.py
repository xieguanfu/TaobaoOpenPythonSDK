...
## @brief 卖家同意退款，支持批量(20笔以内，总金额6000以内)
...
from Domain.RefundAgreeResponse import RefundAgreeResponse



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家同意退款，支持批量(20笔以内，总金额6000以内)</SPAN>
# <UL>
# </UL>
class RpRefundsAgreeResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">同意退款操作返回信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">RefundAgreeResponse</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("response"):
            self.response = self._newInstance("response", kargs["response"])
