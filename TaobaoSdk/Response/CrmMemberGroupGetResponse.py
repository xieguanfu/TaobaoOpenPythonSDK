...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取买家身上的标签，不返回标签的总人数</SPAN>
# <UL>
# </UL>
class CrmMemberGroupGetResponse(object):
