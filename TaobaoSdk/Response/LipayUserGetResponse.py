...
from Domain.AlipayUserDetail import AlipayUserDetail



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询支付宝用户信息</SPAN>
# <UL>
# </UL>
class LipayUserGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">支付宝用户信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">AlipayUserDetail</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "alipay_user_detail": "AlipayUserDetail",
        }
        levels = {
            
            "alipay_user_detail": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("alipay_user_detail"):
            self.alipay_user_detail = self._newInstance("alipay_user_detail", kargs["alipay_user_detail"])
