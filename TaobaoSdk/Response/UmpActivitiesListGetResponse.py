...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 按照营销活动id的列表ids，查询对应的营销活动列表。</SPAN>
# <UL>
# </UL>
class UmpActivitiesListGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">营销活动列表！</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("activities"):
            self.activities = self._newInstance("activities", kargs["activities"])
