...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据类目信息推荐相关联的宝贝集</SPAN>
# <UL>
# </UL>
class CategoryrecommendItemsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回关联的商品集合</SPAN>
        # <UL>
        # <LI>
