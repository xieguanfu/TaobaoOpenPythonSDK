...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 提供app为自己的用户开通增量消息服务功能</SPAN>
# <UL>
# </UL>
class IncrementCustomerPermitResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">当订阅成功后，返回的订阅情况。具体内容见AppCustomer数据结构。</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("app_customer"):
            self.app_customer = self._newInstance("app_customer", kargs["app_customer"])
