...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据商品id查询商品组合关系</SPAN>
# <UL>
# </UL>
class WlbItemCombinationGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">组合子商品id列表</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("item_id_list"):
            self.item_id_list = self._newInstance("item_id_list", kargs["item_id_list"])
