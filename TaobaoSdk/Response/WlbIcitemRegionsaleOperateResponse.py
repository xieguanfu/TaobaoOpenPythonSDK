...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 前台宝贝区域化销售服务添加和删除接口</SPAN>
# <UL>
# </UL>
class WlbIcitemRegionsaleOperateResponse(object):
