...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取更改过的类目出价ID</SPAN>
# <UL>
# </UL>
class SimbaCatmatchidsChangedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">类目出价ID列表</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.changed_catmatch_ids = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "changed_catmatch_ids": "Number",
        }
        levels = {
            
            "changed_catmatch_ids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("changed_catmatch_ids"):
            self.changed_catmatch_ids = self._newInstance("changed_catmatch_ids", kargs["changed_catmatch_ids"])
