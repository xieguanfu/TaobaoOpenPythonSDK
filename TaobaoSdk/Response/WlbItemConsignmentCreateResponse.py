...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 代销商创建商品代销关系：货主创建授权规则，获得授权规则后方可创建商品代销关系。</SPAN>
# <UL>
# </UL>
class WlbItemConsignmentCreateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">代销关系唯一标识</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("consignment_id"):
            self.consignment_id = self._newInstance("consignment_id", kargs["consignment_id"])
