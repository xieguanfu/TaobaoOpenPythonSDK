...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家地址库修改</SPAN>
# <UL>
# </UL>
class LogisticsAddressModifyResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">只返回修改时间modify_date</SPAN>
        # <UL>
        # <LI>
