...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据库存授权结果码移除该授权下的用户库存授权</SPAN>
# <UL>
# </UL>
class InventoryAuthorizeRemoveResponse(object):
