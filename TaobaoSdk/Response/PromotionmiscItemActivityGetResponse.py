...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询无条件单品优惠活动</SPAN>
# <UL>
# </UL>
class PromotionmiscItemActivityGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">单品优惠活动信息。</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("item_promotion"):
            self.item_promotion = self._newInstance("item_promotion", kargs["item_promotion"])
