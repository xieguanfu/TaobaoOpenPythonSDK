...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户对已经冻结的订单可以调用此接口查询明细</SPAN>
# <UL>
# </UL>
class LipayMicropayOrderGetResponse(object):
