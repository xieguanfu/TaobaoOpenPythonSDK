...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 去除活动参与的商品</SPAN>
# <UL>
# </UL>
class PromotionmiscActivityRangeRemoveResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">去除活动参与的商品是否成功。</SPAN>
        # <UL>
        # <LI>
