...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 数据实时回流</SPAN>
# <UL>
# </UL>
class HanoiDataserviceWriteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">如果为true，表示全部写入成功。 如果为false，表示部分失败，或者全部失败。可以从errorMessage获取写入失败的数据源和属性ID</SPAN>
        # <UL>
        # <LI>
