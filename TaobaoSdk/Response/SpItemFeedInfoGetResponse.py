...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取商品评价信息</SPAN>
# <UL>
# </UL>
class SpItemFeedInfoGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">分别返回好评,中评,差评最新的50条, type:评价类型 1好评 0中评 -1差评; nick: 评价者昵称; feedback: 评价内容; date: 评价时间</SPAN>
        # <UL>
        # <LI>
