...
from Domain.TaohuaItem import TaohuaItem



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商品详情接口</SPAN>
# <UL>
# </UL>
class TaohuaItemdetailGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TaohuaItem</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "taohua_item_detail": "TaohuaItem",
        }
        levels = {
            
            "taohua_item_detail": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("taohua_item_detail"):
            self.taohua_item_detail = self._newInstance("taohua_item_detail", kargs["taohua_item_detail"])
