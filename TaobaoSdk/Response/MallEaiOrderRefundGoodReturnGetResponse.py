...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询单笔退货单</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundGoodReturnGetResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("return_bill"):
            self.return_bill = self._newInstance("return_bill", kargs["return_bill"])
