...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询买家信息API，只能买家类应用调用。</SPAN>
# <UL>
# </UL>
class UserBuyerGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">只返回user_id,nick,sex,buyer_credit,avatar,has_shop,vip_info参数</SPAN>
        # <UL>
        # <LI>
