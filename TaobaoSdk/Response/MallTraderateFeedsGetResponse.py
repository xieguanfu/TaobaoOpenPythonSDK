...
## @brief 通过子订单ID获取对应的评价，追评，以及对应的语义标签
...
from Domain.TmallRateInfo import TmallRateInfo



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过子订单ID获取对应的评价，追评，以及对应的语义标签</SPAN>
# <UL>
# </UL>
class MallTraderateFeedsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回评价信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TmallRateInfo</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "tmall_rate_info": "TmallRateInfo",
        }
        levels = {
            
            "tmall_rate_info": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tmall_rate_info"):
            self.tmall_rate_info = self._newInstance("tmall_rate_info", kargs["tmall_rate_info"])
