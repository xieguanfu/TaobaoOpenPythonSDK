...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 类目TOP词查询</SPAN>
# <UL>
# </UL>
class SimbaInsightCatstopwordGetResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("top_words"):
            self.top_words = self._newInstance("top_words", kargs["top_words"])
