...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 此API获取当前卖家店铺在淘宝前端被展示的浏览导航类目（面向买家）</SPAN>
# <UL>
# </UL>
class SellercatsListGetResponse(object):
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "seller_cats": "SellerCat",
        }
        levels = {
            
            "seller_cats": "Object Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("seller_cats"):
            self.seller_cats = self._newInstance("seller_cats", kargs["seller_cats"])
