...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 此接口用于ISV查询订阅信息。</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class IncrementSubscribemessageGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">ISV增量消息订阅信息</SPAN>
        # <UL>
        # <LI>
        ...
        ''' 
        @ivar subscribe_message: ISV增量消息订阅信息; B{Level}: C{Object}; B{Required}: C{true}; B{Sample}: C{};
