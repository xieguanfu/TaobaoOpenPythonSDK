...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 订单全链路状态统计差异比较</SPAN>
# <UL>
# </UL>
class JdsTradesStatisticsDiffResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">pre_status比post_status多的tid列表</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tids"):
            self.tids = self._newInstance("tids", kargs["tids"])
