...
from Domain.TripOrder import TripOrder



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据淘宝系统订单号获取订单详情信息</SPAN>
# <UL>
# </UL>
class JipiaoAgentOrderDetailResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">机票订单的详情列表，当前支持返回一个订单</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TripOrder</SPAN>
        # </LI>
        # <LI>
