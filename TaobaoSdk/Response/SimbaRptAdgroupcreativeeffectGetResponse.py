...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广组下的创意报表效果数据查询(汇总数据，不分类型)</SPAN>
# <UL>
# </UL>
class SimbaRptAdgroupcreativeeffectGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">推广组下的创意效果数据列表</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.rpt_adgroupcreative_effect_list = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_adgroupcreative_effect_list": "String",
        }
        levels = {
            
            "rpt_adgroupcreative_effect_list": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_adgroupcreative_effect_list"):
            self.rpt_adgroupcreative_effect_list = self._newInstance("rpt_adgroupcreative_effect_list", kargs["rpt_adgroupcreative_effect_list"])
