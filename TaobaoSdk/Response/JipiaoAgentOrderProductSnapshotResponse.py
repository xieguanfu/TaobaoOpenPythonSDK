...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取订单对应的产品快照信息</SPAN>
# <UL>
# </UL>
class JipiaoAgentOrderProductSnapshotResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">{ 	"pnr_id": { 		"passengers": ["用户姓名"], 		"isAutoBook": false, 		"segments": [{ 			"depTime": "2014-04-04 15:25:00.0", 			"filghtNO": "KN5856", 			"flightSegment": "SZX-NAY" 		}], 		"pnr": "-", 		"policyMemo": "-", 		"fareMemo": "-", 		"channel": "渠道" 	} }  pnr_id:淘宝内部pnr id 例如72749001 isAutoBook：是否使用淘宝自动出票 passengers：乘客姓名，可包含多个 segments：航段信息 pnr：pnr值 如果没有值，则返回"-" policyMemo：政策备注，如果没有值，则返回"-" fareMemo：运价备注，如果没有值，则返回"-" channel：渠道 例如51book:300001</SPAN>
        # <UL>
        # <LI>
