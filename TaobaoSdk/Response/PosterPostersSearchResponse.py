...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据画报关键词、发布时间、画报制作者、编辑推荐、特色推荐进行搜索，同时支持多种排序方式。此接口至少需要一个查询条件方可进行查询，如key_word，start_date，end_date，channel_ids，editor_recommend，user_nick，recommend_factor，至少有一个查询条件。</SPAN>
# <UL>
# </UL>
class PosterPostersSearchResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("posters"):
            self.posters = self._newInstance("posters", kargs["posters"])
