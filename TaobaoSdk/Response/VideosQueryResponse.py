...
from Domain.VideoItem import VideoItem



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 此api用于批量查询指定视频，不返回已经被用户删除掉的视频，全部查询成功返回成功，不支持部分查询</SPAN>
# <UL>
# </UL>
class VideosQueryResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">批量查询返回的视频列表，返回具体信息为入参fields请求的字段信息</SPAN>
        # <UL>
        # <LI>
