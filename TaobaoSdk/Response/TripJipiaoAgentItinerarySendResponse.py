...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 国内机票代理商行程单信息回填</SPAN>
# <UL>
# </UL>
class TripJipiaoAgentItinerarySendResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">成功或者失败</SPAN>
        # <UL>
        # <LI>
