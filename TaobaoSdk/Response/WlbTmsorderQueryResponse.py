...
from Domain.WlbTmsOrder import WlbTmsOrder

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过物流订单编号分页查询物流信息</SPAN>
# <UL>
# </UL>
class WlbTmsorderQueryResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">物流订单运单信息列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">WlbTmsOrder</SPAN>
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Level</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Object Array</SPAN>
        # </LI>
        # </UL>
        self.tms_order_list = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "tms_order_list": "WlbTmsOrder",
            
            "total_count": "Number",
        }
        levels = {
            
            "tms_order_list": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tms_order_list"):
            self.tms_order_list = self._newInstance("tms_order_list", kargs["tms_order_list"])
