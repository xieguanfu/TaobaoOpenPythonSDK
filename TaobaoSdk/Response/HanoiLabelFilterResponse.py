...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据标签id，卖家和买家Nick，匹配标签</SPAN>
# <UL>
# </UL>
class HanoiLabelFilterResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">匹配结果</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("filter"):
            self.filter = self._newInstance("filter", kargs["filter"])
