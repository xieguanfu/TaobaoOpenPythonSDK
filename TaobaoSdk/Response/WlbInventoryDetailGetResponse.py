...
from Domain.WlbInventory import WlbInventory

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询库存详情，通过商品ID获取发送请求的卖家的库存详情</SPAN>
# <UL>
# </UL>
class WlbInventoryDetailGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">库存详情列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">WlbInventory</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "inventory_list": "WlbInventory",
            
            "item_id": "Number",
        }
        levels = {
            
            "inventory_list": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("inventory_list"):
            self.inventory_list = self._newInstance("inventory_list", kargs["inventory_list"])
