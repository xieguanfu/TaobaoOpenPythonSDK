...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 国内机票代理商手工hk订单（未付款前，手工填写pnr）</SPAN>
# <UL>
# </UL>
class TripJipiaoAgentOrderHkResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">手工HK成功失败</SPAN>
        # <UL>
        # <LI>
