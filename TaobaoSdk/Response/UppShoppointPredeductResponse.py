...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 预扣出买家的店铺积分，及买家店铺积分被冻结</SPAN>
# <UL>
# </UL>
class UppShoppointPredeductResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">用于实际扣减的时候关联系统扣减记录,需要调用方保存。</SPAN>
        # <UL>
        # <LI>
