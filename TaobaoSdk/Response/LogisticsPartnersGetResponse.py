...
from Domain.LogisticsPartner import LogisticsPartner



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询物流公司信息（可以查询目的地可不可达情况）</SPAN>
# <UL>
# </UL>
class LogisticsPartnersGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">LogisticsPartner</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        ...
        levels = {
            ...
            "logistics_partners": "Object Array",
        }
