...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新标签，标签自动审核，立即可用</SPAN>
# <UL>
# </UL>
class HanoiLabelUpdatePapResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">更新操作的结果</SPAN>
        # <UL>
        # <LI>
