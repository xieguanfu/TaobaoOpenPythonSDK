...
from Domain.GradeDiscount import GradeDiscount

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 等级折扣查询</SPAN>
# <UL>
# </UL>
class FenxiaoProductGradepriceGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">等级折扣列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">GradeDiscount</SPAN>
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Level</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Object Array</SPAN>
        # </LI>
        # </UL>
        self.grade_discounts = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "grade_discounts": "GradeDiscount",
            
            "is_success": "Boolean",
        }
        levels = {
            
            "grade_discounts": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("grade_discounts"):
            self.grade_discounts = self._newInstance("grade_discounts", kargs["grade_discounts"])
