...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 供应商或分销商通过采购申请/经销采购单审核</SPAN>
# <UL>
# </UL>
class FenxiaoDealerRequisitionorderAgreeResponse(object):
