...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新一个旅游度假线路商品，目前仅支持8个类目：国内跟团游、国内自由行、国内一日游、出境自由行、出境跟团游、境外跟团游、境外自由行、境外一日游商品的更新。</SPAN>
# <UL>
# </UL>
class TravelItemsUpdateResponse(object):
