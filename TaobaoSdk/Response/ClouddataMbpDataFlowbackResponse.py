...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户通过此接口向上传表上传数据</SPAN>
# <UL>
# </UL>
class ClouddataMbpDataFlowbackResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">执行结果</SPAN>
        # <UL>
        # <LI>
