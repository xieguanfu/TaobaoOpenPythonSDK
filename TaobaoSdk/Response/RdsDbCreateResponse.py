...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 在rds实例里创建数据库</SPAN>
# <UL>
# </UL>
class RdsDbCreateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">rds创建、查询、删除db返回结果的数据结构</SPAN>
        # <UL>
        # <LI>
