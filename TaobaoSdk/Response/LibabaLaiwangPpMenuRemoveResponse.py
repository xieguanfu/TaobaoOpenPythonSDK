...
## @brief 来往公众平台菜单删除API, 删除当前用户创建过的菜单数据.
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 来往公众平台菜单删除API, 删除当前用户创建过的菜单数据.</SPAN>
# <UL>
# </UL>
class LibabaLaiwangPpMenuRemoveResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">删除成功的菜单数量</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("deletedcount"):
            self.deletedcount = self._newInstance("deletedcount", kargs["deletedcount"])
