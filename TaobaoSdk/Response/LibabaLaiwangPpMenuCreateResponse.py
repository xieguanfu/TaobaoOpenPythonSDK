...
## @brief 来往公众账号菜单创建接口：   1. 每个公众账号仅能创建一个公众账号菜单 2. 若存在菜单，再次调用该接口则返回之前的菜单定义
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 来往公众账号菜单创建接口：   1. 每个公众账号仅能创建一个公众账号菜单 2. 若存在菜单，再次调用该接口则返回之前的菜单定义</SPAN>
# <UL>
# </UL>
class LibabaLaiwangPpMenuCreateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">调用是否成功</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("issuccess"):
            self.issuccess = self._newInstance("issuccess", kargs["issuccess"])
