...
from Domain.LoginUser import LoginUser



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取用户登录信息</SPAN>
# <UL>
# </UL>
class FenxiaoLoginUserGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">登录用户信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">LoginUser</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("login_user"):
            self.login_user = self._newInstance("login_user", kargs["login_user"])
