...
from Domain.FenxiaoItemRecord import FenxiaoItemRecord

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 供应商查询分销商商品下载记录。</SPAN>
# <UL>
# </UL>
class FenxiaoDistributorItemsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">FenxiaoItemRecord</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("records"):
            self.records = self._newInstance("records", kargs["records"])
