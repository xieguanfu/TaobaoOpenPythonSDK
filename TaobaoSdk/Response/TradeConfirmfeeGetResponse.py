...
from Domain.TradeConfirmFee import TradeConfirmFee



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取交易确认收货费用 可以获取主订单或子订单的确认收货费用</SPAN>
# <UL>
# </UL>
class TradeConfirmfeeGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TradeConfirmFee</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "trade_confirm_fee": "TradeConfirmFee",
        }
        levels = {
            
            "trade_confirm_fee": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("trade_confirm_fee"):
            self.trade_confirm_fee = self._newInstance("trade_confirm_fee", kargs["trade_confirm_fee"])
