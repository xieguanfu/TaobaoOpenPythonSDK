...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除用户粉丝分组</SPAN>
# <UL>
# </UL>
class WeitaoCloudtagsGroupDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">业务是否执行成功，result仅是系统调用是否成功</SPAN>
        # <UL>
        # <LI>
