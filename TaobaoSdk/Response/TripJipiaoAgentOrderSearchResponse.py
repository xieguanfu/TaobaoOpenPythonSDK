...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据条件查询淘宝订单id列表</SPAN>
# <UL>
# </UL>
class TripJipiaoAgentOrderSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">国内机票订单搜索返回结果对象</SPAN>
        # <UL>
        # <LI>
