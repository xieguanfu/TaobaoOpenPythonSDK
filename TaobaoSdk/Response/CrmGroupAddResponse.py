...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家创建一个新的分组，接口返回一个创建成功的分组的id</SPAN>
# <UL>
# </UL>
class CrmGroupAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">添加分组是否成功</SPAN>
        # <UL>
        # <LI>
