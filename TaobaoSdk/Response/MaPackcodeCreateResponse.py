...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 生成包裹码二维码图片链接</SPAN>
# <UL>
# </UL>
class MaPackcodeCreateResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("qrcodeurl"):
            self.qrcodeurl = self._newInstance("qrcodeurl", kargs["qrcodeurl"])
