...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据商品ID或商家编码修改后端商品</SPAN>
# <UL>
# </UL>
class ScitemUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">更新商品数量,1表示成功更新了一条数据，0：表示未找到匹配的数据</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("update_rows"):
            self.update_rows = self._newInstance("update_rows", kargs["update_rows"])
