...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过api删除用户RDS的数据库</SPAN>
# <UL>
# </UL>
class RdsDbDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">删除数据库，返回结果对象</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rds_db_info"):
            self.rds_db_info = self._newInstance("rds_db_info", kargs["rds_db_info"])
