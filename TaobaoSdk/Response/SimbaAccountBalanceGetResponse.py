...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取实时余额，”元”为单位</SPAN>
# <UL>
# </UL>
class SimbaAccountBalanceGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">实时余额，”元”为单位</SPAN>
        # <UL>
        # <LI>
