...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取消正在开始的店铺优惠券活动</SPAN>
# <UL>
# </UL>
class PromotionActivityCancelResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">true成功，false 失败</SPAN>
        # <UL>
        # <LI>
