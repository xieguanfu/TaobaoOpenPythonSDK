...
from Domain.PurchaseOrder import PurchaseOrder

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分销商或供应商均可用此接口查询采购单信息. (发货处理请调用物流API中的发货接口)</SPAN>
# <UL>
# </UL>
class FenxiaoOrdersGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">PurchaseOrder</SPAN>
        # </LI>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">搜索到的采购单记录总数</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("purchase_orders"):
            self.purchase_orders = self._newInstance("purchase_orders", kargs["purchase_orders"])
