...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 新增优惠活动。设置优惠活动的基本信息，比如活动时间，活动针对的对象（可以是满足某些条件的买家）</SPAN>
# <UL>
# </UL>
class UmpActivityAddResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("act_id"):
            self.act_id = self._newInstance("act_id", kargs["act_id"])
