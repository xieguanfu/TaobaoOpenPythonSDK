...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 异步获取历史分销订单, 查询从昨天到3个月内的分销订单数据。所有数据根据gmt_create 降序排序</SPAN>
# <UL>
# </UL>
class TopatsFenxiaoOrdersGetResponse(object):
