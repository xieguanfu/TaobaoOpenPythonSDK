...
## @brief 获取支付宝用户订购信息。在不确认用户对应用是否订购的时候，可以调用此API查询。
...
from Domain.AlipayContract import AlipayContract



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取支付宝用户订购信息。在不确认用户对应用是否订购的时候，可以调用此API查询。</SPAN>
# <UL>
# </UL>
class LipayUserContractGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">支付宝用户订购信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">AlipayContract</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "alipay_contract": "AlipayContract",
        }
        levels = {
            
            "alipay_contract": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("alipay_contract"):
            self.alipay_contract = self._newInstance("alipay_contract", kargs["alipay_contract"])
