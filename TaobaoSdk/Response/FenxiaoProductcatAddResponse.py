...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 新增产品线</SPAN>
# <UL>
# </UL>
class FenxiaoProductcatAddResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("product_line_id"):
            self.product_line_id = self._newInstance("product_line_id", kargs["product_line_id"])
