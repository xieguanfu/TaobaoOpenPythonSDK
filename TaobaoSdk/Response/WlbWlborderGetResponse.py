...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据物流宝订单编号查询物流宝订单概要信息</SPAN>
# <UL>
# </UL>
class WlbWlborderGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">物流宝订单详情</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("wlb_order"):
            self.wlb_order = self._newInstance("wlb_order", kargs["wlb_order"])
