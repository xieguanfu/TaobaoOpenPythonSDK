...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分销商查询供应商产品信息</SPAN>
# <UL>
# </UL>
class FenxiaoDistributorProductsGetResponse(object):
