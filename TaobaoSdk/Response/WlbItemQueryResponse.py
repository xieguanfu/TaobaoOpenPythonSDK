...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据状态、卖家、SKU等信息查询商品列表</SPAN>
# <UL>
# </UL>
class WlbItemQueryResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">商品信息列表</SPAN>
        # <UL>
        # <LI>
