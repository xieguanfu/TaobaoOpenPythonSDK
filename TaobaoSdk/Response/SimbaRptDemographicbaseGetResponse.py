...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广计划下的人群基础数据查询</SPAN>
# <UL>
# </UL>
class SimbaRptDemographicbaseGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">非搜索推广计划基础数据对象</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.rpt_demographic_base = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_demographic_base": "String",
        }
        levels = {
            
            "rpt_demographic_base": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_demographic_base"):
            self.rpt_demographic_base = self._newInstance("rpt_demographic_base", kargs["rpt_demographic_base"])
