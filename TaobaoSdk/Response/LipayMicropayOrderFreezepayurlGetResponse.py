...
## @brief 用户创建一笔支付订单之后,使用此接口获取支付冻结金的url来支付冻结金
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户创建一笔支付订单之后,使用此接口获取支付冻结金的url来支付冻结金</SPAN>
# <UL>
# </UL>
class LipayMicropayOrderFreezepayurlGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">支付冻结金的地址</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "pay_freeze_url": "String",
        }
        levels = {
            
            "pay_freeze_url": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("pay_freeze_url"):
            self.pay_freeze_url = self._newInstance("pay_freeze_url", kargs["pay_freeze_url"])
