...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 给标签分组添加一个标签，自动审核</SPAN>
# <UL>
# </UL>
class HanoiGroupLabelAddPapResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">添加成功的返回值</SPAN>
        # <UL>
        # <LI>
