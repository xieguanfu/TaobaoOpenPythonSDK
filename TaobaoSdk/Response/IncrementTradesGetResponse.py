...
from Domain.NotifyTrade import NotifyTrade

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 开通主动通知业务的APP可以通过该接口获取用户的交易和评价变更通知信息 <font color="red">建议在获取增量消息的时间间隔是：半个小时</font></SPAN>
# <UL>
# </UL>
class IncrementTradesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">NotifyTrade</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "notify_trades": "NotifyTrade",
            
            "total_results": "Number",
        }
        levels = {
            
            "notify_trades": "Object Array",
