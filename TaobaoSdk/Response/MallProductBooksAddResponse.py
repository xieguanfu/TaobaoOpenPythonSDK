...
## @brief tmall提供给外部商家的接口，外部商家调用接口，可以将商家的图书的类目以及SPU信息推送到tamll的数据库中
...
from Domain.ProductBooks import ProductBooks



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: tmall提供给外部商家的接口，外部商家调用接口，可以将商家的图书的类目以及SPU信息推送到tamll的数据库中</SPAN>
# <UL>
# </UL>
class MallProductBooksAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">请求相应结构</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ProductBooks</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "product_books": "ProductBooks",
        }
        levels = {
            
            "product_books": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("product_books"):
            self.product_books = self._newInstance("product_books", kargs["product_books"])
