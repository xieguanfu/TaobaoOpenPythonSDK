...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新一个推广组的类目出价，可以设置类目出价、是否使用默认出价、是否打开类目出价</SPAN>
# <UL>
# </UL>
class SimbaAdgroupCatmatchUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">推广组的类目出价对象</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("adgroupcatmatch"):
            self.adgroupcatmatch = self._newInstance("adgroupcatmatch", kargs["adgroupcatmatch"])
