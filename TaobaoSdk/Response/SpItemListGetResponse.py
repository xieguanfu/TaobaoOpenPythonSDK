...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商品的多条件搜索</SPAN>
# <UL>
# </UL>
class SpItemListGetResponse(object):
