...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 延长交易收货时间</SPAN>
# <UL>
# </UL>
class TradeReceivetimeDelayResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">更新后的交易数据，只包括tid和modified两个字段。</SPAN>
        # <UL>
        # <LI>
