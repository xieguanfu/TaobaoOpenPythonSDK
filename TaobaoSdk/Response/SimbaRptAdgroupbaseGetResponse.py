...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广组基础报表数据对象</SPAN>
# <UL>
# </UL>
class SimbaRptAdgroupbaseGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">广告组基础数据对象</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.rpt_adgroup_base_list = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_adgroup_base_list": "String",
        }
        levels = {
            
            "rpt_adgroup_base_list": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_adgroup_base_list"):
            self.rpt_adgroup_base_list = self._newInstance("rpt_adgroup_base_list", kargs["rpt_adgroup_base_list"])
