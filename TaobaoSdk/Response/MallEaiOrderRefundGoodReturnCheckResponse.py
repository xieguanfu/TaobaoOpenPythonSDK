...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家验货回写订单号</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundGoodReturnCheckResponse(object):
