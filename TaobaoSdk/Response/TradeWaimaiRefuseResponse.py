...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商家拒绝订单，产生退款操作</SPAN>
# <UL>
# </UL>
class TradeWaimaiRefuseResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">0:失败 1:成功</SPAN>
        # <UL>
        # <LI>
