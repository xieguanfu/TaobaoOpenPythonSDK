...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户接入时调用该 API 进行授权初始化的操作。 调用该 API的目的是告知订单数据中心， 外部用户需要的是哪个卖家的订单数据。 同时告知我们对开放出去的该卖家的订单数据的负责用户是谁。 "负责用户"可以是卖家本身。也可以是ISV。</SPAN>
# <UL>
# </UL>
class MallEaiBaseGatewayRegisterResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">操作插入删除或者更新的记录数</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">调用结果成功与否</SPAN>
        # <UL>
        # <LI>
