...
from Domain.EbookLib import EbookLib

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分页查询参加活动的电子书的书库信息。</SPAN>
# <UL>
# </UL>
class EbookLibsSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">EbookLib</SPAN>
        # </LI>
        # <LI>
