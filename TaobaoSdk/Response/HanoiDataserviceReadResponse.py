...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 店铺会员数据读取。一次可读取一个用户的多个属性值，但所有属性值的主键必须一致。主键不一致的属性值，请分多次读取。</SPAN>
# <UL>
# </UL>
class HanoiDataserviceReadResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">json格式的kv对。k是属性的key，v是属性值。</SPAN>
        # <UL>
        # <LI>
