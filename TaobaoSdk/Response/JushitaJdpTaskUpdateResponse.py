...
## @brief 数据推送2.0中，SDK通过此api把任务的执行结果更新回TOP
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 数据推送2.0中，SDK通过此api把任务的执行结果更新回TOP</SPAN>
# <UL>
# </UL>
class JushitaJdpTaskUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">更新任务是否成功</SPAN>
        # <UL>
        # <LI>
