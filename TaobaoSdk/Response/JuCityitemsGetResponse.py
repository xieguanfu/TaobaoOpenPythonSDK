...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据城市，获取对应的生活服务团商品接口</SPAN>
# <UL>
# </UL>
class JuCityitemsGetResponse(object):
