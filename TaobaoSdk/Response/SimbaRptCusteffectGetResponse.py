...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户账户报表效果数据查询（只有汇总数据，无分类数据）</SPAN>
# <UL>
# </UL>
class SimbaRptCusteffectGetResponse(object):
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_cust_effect_list": "String",
        }
        levels = {
            
            "rpt_cust_effect_list": "Basic",
        }
