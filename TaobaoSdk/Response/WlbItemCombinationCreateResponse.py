...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建商品组合关系</SPAN>
# <UL>
# </UL>
class WlbItemCombinationCreateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">组合关系创建时间</SPAN>
        # <UL>
        # <LI>
