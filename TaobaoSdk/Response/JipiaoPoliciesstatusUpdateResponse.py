...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据条件大批量更新产品，目前只支持删除,每十分钟只允许调用一次,更新记录数不能超过10W个</SPAN>
# <UL>
# </UL>
class JipiaoPoliciesstatusUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">代理商核对接收处理信息的时间序号</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">机票政策状态更新任务提交结果，true，成功；false，失败</SPAN>
        # <UL>
        # <LI>
