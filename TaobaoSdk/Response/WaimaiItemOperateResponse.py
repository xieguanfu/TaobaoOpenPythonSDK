...
from Domain.BatchOperateResult import BatchOperateResult



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商品上下架、删除接口</SPAN>
# <UL>
# </UL>
class WaimaiItemOperateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">批量操作结果</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">BatchOperateResult</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.batch_operate_result = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "batch_operate_result": "BatchOperateResult",
        }
        levels = {
            
            "batch_operate_result": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("batch_operate_result"):
            self.batch_operate_result = self._newInstance("batch_operate_result", kargs["batch_operate_result"])
