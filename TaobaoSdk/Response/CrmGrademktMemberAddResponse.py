...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商家通过该接口吸纳线上店铺会员。</SPAN>
# <UL>
# </UL>
class CrmGrademktMemberAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回操作是否成功</SPAN>
        # <UL>
        # <LI>
