...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建物流宝外部订单（E链通等）</SPAN>
# <UL>
# </UL>
class WlbExtorderCreateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">订单创建时间</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">物流宝外部订单创建成功后，返回物流宝的外部订单编号；如果订单创建失败，该字段为空。</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "ext_order_code": "String",
        }
        levels = {
            
            "create_time": "Basic",
            
            "ext_order_code": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("ext_order_code"):
            self.ext_order_code = self._newInstance("ext_order_code", kargs["ext_order_code"])
