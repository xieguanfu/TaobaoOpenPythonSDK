...
from Domain.TbkItem import TbkItem
...
# <UL>
# </UL>
class TbkItemsConvertResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TbkItem</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tbk_items"):
            self.tbk_items = self._newInstance("tbk_items", kargs["tbk_items"])
