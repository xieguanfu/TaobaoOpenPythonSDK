...
from Domain.PromotionTagQuery import PromotionTagQuery



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询用户创建的所有标签</SPAN>
# <UL>
# </UL>
class MallPromotagTagFindResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">查询结果类型</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">PromotionTagQuery</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "query_result": "PromotionTagQuery",
        }
        levels = {
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("query_result"):
            self.query_result = self._newInstance("query_result", kargs["query_result"])
