...
from Domain.CampaignBudget import CampaignBudget



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新一个推广计划的日限额</SPAN>
# <UL>
# </UL>
class SimbaCampaignBudgetUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">修改后的推广计划日限额</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">CampaignBudget</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("campaign_budget"):
            self.campaign_budget = self._newInstance("campaign_budget", kargs["campaign_budget"])
