...
## @brief 用于发账单业务中，提交下载用户户号请求，文件生成成功之后，会通知下载地址。
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用于发账单业务中，提交下载用户户号请求，文件生成成功之后，会通知下载地址。</SPAN>
# <UL>
# </UL>
class LipayEbppBillKeySearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">请求受理ID。</SPAN>
        # <UL>
        # <LI>
