...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取删除的创意ID</SPAN>
# <UL>
# </UL>
class SimbaCreativeidsDeletedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # </LI>
        # </UL>
        self.deleted_creative_ids = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "deleted_creative_ids": "Number",
        }
        levels = {
            
            "deleted_creative_ids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("deleted_creative_ids"):
            self.deleted_creative_ids = self._newInstance("deleted_creative_ids", kargs["deleted_creative_ids"])
