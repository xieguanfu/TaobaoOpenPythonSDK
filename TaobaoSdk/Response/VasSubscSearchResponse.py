...
from Domain.ArticleSub import ArticleSub

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用于ISV查询自己名下的应用及收费项目的订购记录</SPAN>
# <UL>
# </UL>
class VasSubscSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ArticleSub</SPAN>
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Level</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Object Array</SPAN>
        # </LI>
        # </UL>
        self.article_subs = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "article_subs": "ArticleSub",
            
            "total_item": "Number",
        }
        levels = {
            
            "article_subs": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("article_subs"):
            self.article_subs = self._newInstance("article_subs", kargs["article_subs"])
