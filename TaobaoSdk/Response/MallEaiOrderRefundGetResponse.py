...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询单笔退款单</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundGetResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("refund_bill"):
            self.refund_bill = self._newInstance("refund_bill", kargs["refund_bill"])
