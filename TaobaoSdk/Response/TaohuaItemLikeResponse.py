...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户调本接口后，对应的商品喜欢值加1</SPAN>
# <UL>
# </UL>
class TaohuaItemLikeResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">成功返回success</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("like_result"):
            self.like_result = self._newInstance("like_result", kargs["like_result"])
