...
from Domain.MicroPayOrderDetail import MicroPayOrderDetail



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 该接口是支付宝提成冻结支付宝资金的操作</SPAN>
# <UL>
# </UL>
class LipayMicropayOrderFreezeResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">MicroPayOrderDetail</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.micro_pay_order_detail = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "micro_pay_order_detail": "MicroPayOrderDetail",
        }
        levels = {
            
            "micro_pay_order_detail": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("micro_pay_order_detail"):
            self.micro_pay_order_detail = self._newInstance("micro_pay_order_detail", kargs["micro_pay_order_detail"])
