...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 产品图片删除，只删除图片信息，不真正删除图片</SPAN>
# <UL>
# </UL>
class FenxiaoProductImageDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">操作结果</SPAN>
        # <UL>
        # <LI>
