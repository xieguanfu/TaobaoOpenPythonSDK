...
from Domain.SubUserPermission import SubUserPermission



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询指定的子账号的被直接赋予的权限信息和角色信息。<br/>返回对象中包括直接赋予子账号的权限点信息、被赋予的角色以及角色的对应权限点信息。</SPAN>
# <UL>
# </UL>
class SellercenterSubuserPermissionsRolesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">子账号被所拥有的权限</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">SubUserPermission</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "subuser_permission": "SubUserPermission",
        }
        levels = {
            
            "subuser_permission": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("subuser_permission"):
            self.subuser_permission = self._newInstance("subuser_permission", kargs["subuser_permission"])
