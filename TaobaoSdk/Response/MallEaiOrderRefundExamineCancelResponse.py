...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 退款单反审核结果回写</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundExamineCancelResponse(object):
