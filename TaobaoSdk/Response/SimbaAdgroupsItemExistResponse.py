...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 判断在一个推广计划中是否已经推广了一个商品</SPAN>
# <UL>
# </UL>
class SimbaAdgroupsItemExistResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">true表示已经被推广，false表示没有被推广</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("exist"):
            self.exist = self._newInstance("exist", kargs["exist"])
