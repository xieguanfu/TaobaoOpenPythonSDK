...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据外部实体类型和实体id查询映射的物流宝商品id</SPAN>
# <UL>
# </UL>
class WlbItemMapGetByExtentityResponse(object):
