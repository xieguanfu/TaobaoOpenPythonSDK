...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取得当前登录用户的授权账户列表</SPAN>
# <UL>
# </UL>
class SimbaCustomersAuthorizedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">授权当前登录账户为代理账户的昵称列表</SPAN>
        # <UL>
        # <LI>
