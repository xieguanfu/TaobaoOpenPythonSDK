...
from Domain.NotifyRefund import NotifyRefund

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 开通主动通知业务的APP可以通过该接口获取用户的退款变更通知信息 <font color="red">建议在获取增量消息的时间间隔是：半个小时</font></SPAN>
# <UL>
# </UL>
class IncrementRefundsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">获取的退款通知消息体 ，具体字段见NotifyRefund数据结构</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">NotifyRefund</SPAN>
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Level</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Object Array</SPAN>
        # </LI>
        # </UL>
        self.notify_refunds = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "notify_refunds": "NotifyRefund",
            
            "total_results": "Number",
        }
        levels = {
            
            "notify_refunds": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("notify_refunds"):
            self.notify_refunds = self._newInstance("notify_refunds", kargs["notify_refunds"])
