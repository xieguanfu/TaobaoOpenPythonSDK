...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 国内机票代理商确认订单接口</SPAN>
# <UL>
# </UL>
class TripJipiaoAgentOrderConfirmResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">确认成功失败</SPAN>
        # <UL>
        # <LI>
