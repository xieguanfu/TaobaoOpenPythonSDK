...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 对买家已付款状态的交易进行发货操作。(注：该API不支持货到付款订单发货)</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class DeliverySendResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">只返回is_success</SPAN>
        # <UL>
        # <LI>
        ...
        self.shipping = None
        ''' 
        @ivar shipping: 只返回is_success; B{Level}: C{Object}; B{Required}: C{true}; B{Sample}: C{};
