...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取修改的词ID</SPAN>
# <UL>
# </UL>
class SimbaKeywordidsChangedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">词的ID列表</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "changed_keyword_ids": "Number",
        }
        levels = {
            
            "changed_keyword_ids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("changed_keyword_ids"):
            self.changed_keyword_ids = self._newInstance("changed_keyword_ids", kargs["changed_keyword_ids"])
