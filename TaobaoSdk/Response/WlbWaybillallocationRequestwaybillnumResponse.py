...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商家申请电子面单</SPAN>
# <UL>
# </UL>
class WlbWaybillallocationRequestwaybillnumResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">电子面单号码</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">String</SPAN>
        # </LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "tms_waybill_list": "String",
        }
        levels = {
            
            "service_code": "Basic",
            
            "tms_waybill_list": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tms_waybill_list"):
            self.tms_waybill_list = self._newInstance("tms_waybill_list", kargs["tms_waybill_list"])
