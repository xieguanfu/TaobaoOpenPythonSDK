...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 批量删除某个DT下面的关联指标关系。 Opened必填，dataTemplateId必填。</SPAN>
# <UL>
# </UL>
class HanoiDatatemplateDetailDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回删除的条数</SPAN>
        # <UL>
        # <LI>
