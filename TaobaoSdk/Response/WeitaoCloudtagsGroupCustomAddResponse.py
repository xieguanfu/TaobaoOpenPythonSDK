...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建卖家自定义的分组，区别于系统内部已有的分组。</SPAN>
# <UL>
# </UL>
class WeitaoCloudtagsGroupCustomAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">新创建的自定义分组id，未生效。</SPAN>
        # <UL>
        # <LI>
