...
from Domain.EbookMediaChapter import EbookMediaChapter



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 添加电子书的章节信息</SPAN>
# <UL>
# </UL>
class EbookmediaChapterAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">电子书章节信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">EbookMediaChapter</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "ebook_chapter": "EbookMediaChapter",
        }
        levels = {
            
            "ebook_chapter": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("ebook_chapter"):
            self.ebook_chapter = self._newInstance("ebook_chapter", kargs["ebook_chapter"])
