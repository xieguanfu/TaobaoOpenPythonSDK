...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分组匹配</SPAN>
# <UL>
# </UL>
class HanoiGroupFilterResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">分组中匹配成功的标签id列表</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("label_list"):
            self.label_list = self._newInstance("label_list", kargs["label_list"])
