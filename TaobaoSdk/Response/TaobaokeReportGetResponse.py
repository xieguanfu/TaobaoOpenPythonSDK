...
from Domain.TaobaokeReport import TaobaokeReport



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 淘宝客报表查询</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class TaobaokeReportGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">淘宝客报表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TaobaokeReport</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.taobaoke_report = None
        ''' 
        @ivar taobaoke_report: 淘宝客报表; B{Level}: C{Object}; B{Required}: C{false}; B{Sample}: C{};
        @type taobaoke_report: TaobaokeReport
        '''
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "taobaoke_report": "TaobaokeReport",
        }
        levels = {
            
            "taobaoke_report": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("taobaoke_report"):
            self.taobaoke_report = self._newInstance("taobaoke_report", kargs["taobaoke_report"])
        pass
