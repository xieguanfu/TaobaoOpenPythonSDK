...
## @brief 调用该接口 会创建一个二级类目为网络文学原创电子书商品
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 调用该接口 会创建一个二级类目为网络文学原创电子书商品</SPAN>
# <UL>
# </UL>
class ItemEbookSerialAddResponse(object):
