...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取删除的推广组ID</SPAN>
# <UL>
# </UL>
class SimbaAdgroupidsDeletedGetResponse(object):
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "deleted_adgroup_ids": "Number",
        }
        levels = {
            
            "deleted_adgroup_ids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("deleted_adgroup_ids"):
            self.deleted_adgroup_ids = self._newInstance("deleted_adgroup_ids", kargs["deleted_adgroup_ids"])
