...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: * 单个商品下架     * 输入的num_iid必须属于当前会话用户</SPAN>
# <UL>
# </UL>
class ItemUpdateDelistingResponse(object):
