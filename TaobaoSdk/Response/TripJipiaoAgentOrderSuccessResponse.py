...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 淘宝机票代理商成功/解冻订单</SPAN>
# <UL>
# </UL>
class TripJipiaoAgentOrderSuccessResponse(object):
