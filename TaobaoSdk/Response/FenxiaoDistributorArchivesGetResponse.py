...
from Domain.DistributorArchive import DistributorArchive

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取当前供应商授权分销商的产品的下载率，计算逻辑同后台页面。downLoadRatio 获取当前供应商授权分销商的产品的上架率，计算逻辑同后台页面。获取upSelfRatio 获取当前供应商在分销商店铺中的上架商品占比。upShopRatio 获取当前供应商在分销商店铺中的成交（已付款）订单笔数占比。 orderShopRatio 获取当前供应商在分销商店铺中铺货商品UV占店铺商品总UV的比。uvShopRatio</SPAN>
# <UL>
# </UL>
class FenxiaoDistributorArchivesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">分销商档案</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">DistributorArchive</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.distributor_archive = None
        
        
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">接口执行结果，true表示执行成功；false表示执行失败。</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "distributor_archive": "DistributorArchive",
            
            "is_success": "Boolean",
        }
        levels = {
            
            "distributor_archive": "Object",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("distributor_archive"):
            self.distributor_archive = self._newInstance("distributor_archive", kargs["distributor_archive"])
