...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询活动详情</SPAN>
# <UL>
# </UL>
class UmpDetailGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">活动详情信息，可以通过ump sdk中的MarketingTool来进行处理</SPAN>
        # <UL>
        # <LI>
