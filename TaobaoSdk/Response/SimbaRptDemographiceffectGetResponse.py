...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广计划下的人群维度效果数据查询</SPAN>
# <UL>
# </UL>
class SimbaRptDemographiceffectGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # </LI>
        # </UL>
        self.rpt_demographic_effect = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_demographic_effect": "String",
        }
        levels = {
            
            "rpt_demographic_effect": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_demographic_effect"):
            self.rpt_demographic_effect = self._newInstance("rpt_demographic_effect", kargs["rpt_demographic_effect"])
