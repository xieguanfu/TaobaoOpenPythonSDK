...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 1.传入属性图片ID  2.传入产品ID  删除一个产品的属性图片</SPAN>
# <UL>
# </UL>
class ProductPropimgDeleteResponse(object):
