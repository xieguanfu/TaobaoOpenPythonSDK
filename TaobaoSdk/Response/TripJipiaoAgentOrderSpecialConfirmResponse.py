...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 国内机票订单接口，确认特殊产品能否支付</SPAN>
# <UL>
# </UL>
class TripJipiaoAgentOrderSpecialConfirmResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">确认能否支付成功失败</SPAN>
        # <UL>
        # <LI>
