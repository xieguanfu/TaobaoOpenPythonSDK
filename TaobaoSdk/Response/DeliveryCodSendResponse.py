...
from Domain.Shipping import Shipping



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户调用该接口可实现cod发货</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class DeliveryCodSendResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">只返回is_success：是否成功。</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Shipping</SPAN>
        # </LI>
        # <LI>
        ...
        self.shipping = None
        ''' 
        @ivar shipping: 只返回is_success：是否成功。; B{Level}: C{Object}; B{Required}: C{true}; B{Sample}: C{};
