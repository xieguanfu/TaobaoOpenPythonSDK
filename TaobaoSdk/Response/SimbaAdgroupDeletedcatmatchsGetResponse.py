...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取删除的类目出价列表（只存类目出价ID和推广组ID）</SPAN>
# <UL>
# </UL>
class SimbaAdgroupDeletedcatmatchsGetResponse(object):
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "deleted_catmatchs": "ADGroupCatMatchPage",
        }
        levels = {
            
            "deleted_catmatchs": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("deleted_catmatchs"):
            self.deleted_catmatchs = self._newInstance("deleted_catmatchs", kargs["deleted_catmatchs"])
