...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 自定义报表引擎授权注册接口</SPAN>
# <UL>
# </UL>
class LzCenterPermRegisterResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">注册结果 success|failure</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("register_result"):
            self.register_result = self._newInstance("register_result", kargs["register_result"])
