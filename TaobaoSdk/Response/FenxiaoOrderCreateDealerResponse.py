...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分销商创建经销采购单.</SPAN>
# <UL>
# </UL>
class FenxiaoOrderCreateDealerResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">采购单号</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("get_module"):
            self.get_module = self._newInstance("get_module", kargs["get_module"])
