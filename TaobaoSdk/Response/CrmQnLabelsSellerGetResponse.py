...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 给千牛旺旺插件单独接口获取卖家设置的标签</SPAN>
# <UL>
# </UL>
class CrmQnLabelsSellerGetResponse(object):
