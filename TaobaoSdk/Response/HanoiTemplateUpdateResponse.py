...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新一个模板。包括模板的名称、编码、使用的属性和参数</SPAN>
# <UL>
# </UL>
class HanoiTemplateUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">成功修改的结果</SPAN>
        # <UL>
        # <LI>
