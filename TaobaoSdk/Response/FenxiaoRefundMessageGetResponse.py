...
from Domain.OrderMessage import OrderMessage

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据子采购单id，查询对应子单的退款留言信息</SPAN>
# <UL>
# </UL>
class FenxiaoRefundMessageGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">总留言条数</SPAN>
        # <UL>
        # <LI>
