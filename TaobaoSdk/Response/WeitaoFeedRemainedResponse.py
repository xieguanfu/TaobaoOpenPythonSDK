...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取当前登录用户还能发送多少条Feed</SPAN>
# <UL>
# </UL>
class WeitaoFeedRemainedResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">今天还能发送多少条Feed</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.remained_count = None
        
        
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">今天发送的Feed的数目</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("remained_count"):
            self.remained_count = self._newInstance("remained_count", kargs["remained_count"])
        
        if kargs.has_key("send_count"):
            self.send_count = self._newInstance("send_count", kargs["send_count"])
