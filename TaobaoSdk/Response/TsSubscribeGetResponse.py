...
from Domain.ServiceSubscribe import ServiceSubscribe



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: ts订购关系状态查询. 暂只支持1口价服务.</SPAN>
# <UL>
# </UL>
class TsSubscribeGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">订购关系对象</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ServiceSubscribe</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("service_subscribe"):
            self.service_subscribe = self._newInstance("service_subscribe", kargs["service_subscribe"])
