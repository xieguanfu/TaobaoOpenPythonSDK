...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新商品SKU的价格</SPAN>
# <UL>
# </UL>
class ItemSkuPriceUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">商品SKU信息（只包含num_iid和modified）</SPAN>
        # <UL>
        # <LI>
