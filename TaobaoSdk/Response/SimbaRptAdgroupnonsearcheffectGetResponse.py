...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广组下的定向推广效果数据查询</SPAN>
# <UL>
# </UL>
class SimbaRptAdgroupnonsearcheffectGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">非搜索推广组效果对象</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.rpt_adgroup_nonsearch_effect = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_adgroup_nonsearch_effect": "String",
        }
        levels = {
            
            "rpt_adgroup_nonsearch_effect": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_adgroup_nonsearch_effect"):
            self.rpt_adgroup_nonsearch_effect = self._newInstance("rpt_adgroup_nonsearch_effect", kargs["rpt_adgroup_nonsearch_effect"])
