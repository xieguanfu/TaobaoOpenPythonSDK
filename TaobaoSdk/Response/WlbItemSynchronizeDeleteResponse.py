...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过物流宝商品ID和IC商品ID删除映射关系。</SPAN>
# <UL>
# </UL>
class WlbItemSynchronizeDeleteResponse(object):
