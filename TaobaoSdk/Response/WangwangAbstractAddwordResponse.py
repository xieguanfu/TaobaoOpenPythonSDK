...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 增加关键词，只支持json返回</SPAN>
# <UL>
# </UL>
class WangwangAbstractAddwordResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">例如单词长度太长等，当ret_code=-1时才有这项</SPAN>
        # <UL>
        # <LI>
