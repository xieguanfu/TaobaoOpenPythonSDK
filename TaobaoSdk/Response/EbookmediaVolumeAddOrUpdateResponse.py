...
from Domain.EbookMediaVolume import EbookMediaVolume



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用户通过调用此API来添加或更新电子书卷信息</SPAN>
# <UL>
# </UL>
class EbookmediaVolumeAddOrUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">电子书卷信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">EbookMediaVolume</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("ebook_volume"):
            self.ebook_volume = self._newInstance("ebook_volume", kargs["ebook_volume"])
