...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 提供按照全量或增量形式修改宝贝/SKU库存的功能</SPAN>
# <UL>
# </UL>
class ItemQuantityUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">iid、numIid、num和modified，skus中每个sku的skuId、quantity和modified</SPAN>
        # <UL>
        # <LI>
