...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 1.传入非主图ID  2.传入产品ID  删除产品非主图</SPAN>
# <UL>
# </UL>
class ProductImgDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回productimg中的：id,product_id</SPAN>
        # <UL>
        # <LI>
