...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: * 单个商品上架 * 输入的num_iid必须属于当前会话用户</SPAN>
# <UL>
# </UL>
class ItemUpdateListingResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">上架后返回的商品信息：返回的结果就是:num_iid和modified</SPAN>
        # <UL>
        # <LI>
