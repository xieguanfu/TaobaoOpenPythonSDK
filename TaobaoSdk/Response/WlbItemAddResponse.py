...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 添加物流宝商品，支持物流宝子商品和属性添加</SPAN>
# <UL>
# </UL>
class WlbItemAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">新增的商品</SPAN>
        # <UL>
        # <LI>
