...
## @brief 内容发布接口，能够新增或更新内容到建站平台的内容服务
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 内容发布接口，能够新增或更新内容到建站平台的内容服务</SPAN>
# <UL>
# </UL>
class SpContentPublishResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">主键ID</SPAN>
        # <UL>
        # <LI>
