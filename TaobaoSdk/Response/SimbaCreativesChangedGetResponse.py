...
from Domain.CreativePage import CreativePage



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分页获取修改过的广告创意ID和修改时间</SPAN>
# <UL>
# </UL>
class SimbaCreativesChangedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">CreativePage</SPAN>
        # </LI>
        # <LI>
