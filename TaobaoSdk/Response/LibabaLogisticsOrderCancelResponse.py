...
from Domain.CancelOrderResult import CancelOrderResult



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 运单发货后，客户或者系统需要撤销运单时，调用撤销接口。</SPAN>
# <UL>
# </UL>
class LibabaLogisticsOrderCancelResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">撤销物流订单结果</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">CancelOrderResult</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "cancel_order_result": "CancelOrderResult",
        }
        levels = {
            
            "cancel_order_result": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("cancel_order_result"):
            self.cancel_order_result = self._newInstance("cancel_order_result", kargs["cancel_order_result"])
