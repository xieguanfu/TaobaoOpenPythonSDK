...
## @brief 卖家预发放店铺积分，卖家发放部分的店铺积分处于冻结状态。
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家预发放店铺积分，卖家发放部分的店铺积分处于冻结状态。</SPAN>
# <UL>
# </UL>
class UppShoppointPresendResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">用于实际发放的时候关联系统发放记录,需要调用方保存</SPAN>
        # <UL>
        # <LI>
