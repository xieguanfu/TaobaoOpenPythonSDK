...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询满就送活动</SPAN>
# <UL>
# </UL>
class PromotionmiscMjsActivityGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">满就送活动信息。</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "mjs_promotion": "MjsPromotion",
        }
        levels = {
            
            "mjs_promotion": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("mjs_promotion"):
            self.mjs_promotion = self._newInstance("mjs_promotion", kargs["mjs_promotion"])
