...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 确认物流宝可执行消息</SPAN>
# <UL>
# </UL>
class WlbNotifyMessageConfirmResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">物流宝消息确认时间</SPAN>
        # <UL>
        # <LI>
