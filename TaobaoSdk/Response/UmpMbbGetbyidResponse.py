...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据积木块id获取营销积木块。</SPAN>
# <UL>
# </UL>
class UmpMbbGetbyidResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">营销积木块定义信息，可以通过ump sdk里面的MBB.fromJson来处理</SPAN>
        # <UL>
        # <LI>
