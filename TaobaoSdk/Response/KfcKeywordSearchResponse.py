...
from Domain.KfcSearchResult import KfcSearchResult



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 对输入的文本信息进行禁忌关键词匹配，返回匹配的结果</SPAN>
# <UL>
# </UL>
class KfcKeywordSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">KFC关键词匹配返回的结果信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">KfcSearchResult</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "kfc_search_result": "KfcSearchResult",
        }
        levels = {
            
            "kfc_search_result": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("kfc_search_result"):
            self.kfc_search_result = self._newInstance("kfc_search_result", kargs["kfc_search_result"])
