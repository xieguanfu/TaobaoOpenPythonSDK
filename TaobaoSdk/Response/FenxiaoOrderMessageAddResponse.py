...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 添加采购单留言，最多20条（供应商分销商都可添加）</SPAN>
# <UL>
# </UL>
class FenxiaoOrderMessageAddResponse(object):
