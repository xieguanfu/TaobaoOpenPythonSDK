...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: ISV通过该接口可以获取算法容器中产出的数据。如果使用了mbp中的算法容器，则需要通过此接口来获取结果</SPAN>
# <UL>
# </UL>
class ClouddataMbpAlgGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">模型预测结果头信息。</SPAN>
        # <UL>
        # <LI>
