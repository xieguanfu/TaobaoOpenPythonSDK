...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 终止与分销商的合作关系</SPAN>
# <UL>
# </UL>
class FenxiaoCooperationTerminateResponse(object):
