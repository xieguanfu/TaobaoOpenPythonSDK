...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: ID必填， Opened必填。<br/> 现阶段只根据ID删除,只能删除未审核的数据模板，数据模板审核后,不能删除。 用法：<br/>  {"id":888888,"opened":0}</SPAN>
# <UL>
# </UL>
class HanoiDatatemplateDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否删除成功</SPAN>
        # <UL>
        # <LI>
