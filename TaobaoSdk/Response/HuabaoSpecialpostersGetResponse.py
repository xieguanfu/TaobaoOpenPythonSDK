...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取指定频道Id的指定条数推荐画报</SPAN>
# <UL>
# </UL>
class HuabaoSpecialpostersGetResponse(object):
