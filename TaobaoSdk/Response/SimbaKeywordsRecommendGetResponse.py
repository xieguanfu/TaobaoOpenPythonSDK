...
from Domain.RecommendWordPage import RecommendWordPage



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取得一个推广组的推荐关键词列表</SPAN>
# <UL>
# </UL>
class SimbaKeywordsRecommendGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">RecommendWordPage</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "recommend_words": "RecommendWordPage",
        }
        levels = {
            
            "recommend_words": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("recommend_words"):
            self.recommend_words = self._newInstance("recommend_words", kargs["recommend_words"])
