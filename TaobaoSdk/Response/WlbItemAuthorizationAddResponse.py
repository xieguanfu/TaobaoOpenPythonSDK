...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 添加商品的授权规则：添加规则之后代销商可以增加商品代销关系</SPAN>
# <UL>
# </UL>
class WlbItemAuthorizationAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">授权规则ID列表</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rule_id_list"):
            self.rule_id_list = self._newInstance("rule_id_list", kargs["rule_id_list"])
