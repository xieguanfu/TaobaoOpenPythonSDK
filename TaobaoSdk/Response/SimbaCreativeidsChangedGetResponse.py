...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取修改的创意ID</SPAN>
# <UL>
# </UL>
class SimbaCreativeidsChangedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">创意ID列表</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.changed_creative_ids = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "changed_creative_ids": "Number",
        }
        levels = {
            
            "changed_creative_ids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("changed_creative_ids"):
            self.changed_creative_ids = self._newInstance("changed_creative_ids", kargs["changed_creative_ids"])
