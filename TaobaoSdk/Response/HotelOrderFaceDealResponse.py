...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 该接口用于卖家确认到店支付订单或者取消订单。</SPAN>
# <UL>
# </UL>
class HotelOrderFaceDealResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">处理结果</SPAN>
        # <UL>
        # <LI>
