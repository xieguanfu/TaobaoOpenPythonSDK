...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 类目相关词查询</SPAN>
# <UL>
# </UL>
class SimbaInsightCatsrelatedwordGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">类目相关词对象列表</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("related_words"):
            self.related_words = self._newInstance("related_words", kargs["related_words"])
