...
from Domain.ConsignResult import ConsignResult



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 货运发货接口。通过该接口可以在通过淘宝对物流公司下单，并且可以享有部分折扣优惠。</SPAN>
# <UL>
# </UL>
class LibabaLogisticsOrderConsignResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">发货结果</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ConsignResult</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "consign_result": "ConsignResult",
        }
        levels = {
            
            "consign_result": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("consign_result"):
            self.consign_result = self._newInstance("consign_result", kargs["consign_result"])
