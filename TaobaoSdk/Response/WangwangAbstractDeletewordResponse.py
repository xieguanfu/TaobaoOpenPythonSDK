...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除关键词，只支持json返回</SPAN>
# <UL>
# </UL>
class WangwangAbstractDeletewordResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">例如单词长度太长等</SPAN>
        # <UL>
        # <LI>
