...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取今日有生活服务商品的城市列表</SPAN>
# <UL>
# </UL>
class JuCitiesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回城市名称列表类似 "上海","成都"</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("cities"):
            self.cities = self._newInstance("cities", kargs["cities"])
