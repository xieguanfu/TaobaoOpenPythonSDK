...
from Domain.UnfreezeOrderDetail import UnfreezeOrderDetail



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 解冻冻结单API</SPAN>
# <UL>
# </UL>
class LipayMicropayOrderUnfreezeResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">冻结订单详情结果</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">UnfreezeOrderDetail</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.unfreeze_order_detail = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "unfreeze_order_detail": "UnfreezeOrderDetail",
        }
        levels = {
            
            "unfreeze_order_detail": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("unfreeze_order_detail"):
            self.unfreeze_order_detail = self._newInstance("unfreeze_order_detail", kargs["unfreeze_order_detail"])
