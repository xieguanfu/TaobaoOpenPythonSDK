...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取用户创建的所有自定义分类</SPAN>
# <UL>
# </UL>
class SpContentGetallclassResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回Json格式的分类名称列表</SPAN>
        # <UL>
        # <LI>
