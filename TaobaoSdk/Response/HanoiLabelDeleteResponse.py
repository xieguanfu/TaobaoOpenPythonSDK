...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除某个标签，前提是该标签没有被标签组引用</SPAN>
# <UL>
# </UL>
class HanoiLabelDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">删除标签成功结果</SPAN>
        # <UL>
        # <LI>
