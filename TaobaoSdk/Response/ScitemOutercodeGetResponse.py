...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据outerCode查询商品</SPAN>
# <UL>
# </UL>
class ScitemOutercodeGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">后台商品</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("sc_item"):
            self.sc_item = self._newInstance("sc_item", kargs["sc_item"])
