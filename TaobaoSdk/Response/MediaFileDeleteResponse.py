...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 多媒体平台文件的删除，支持批量</SPAN>
# <UL>
# </UL>
class MediaFileDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">全部删除成功返回“”，部分删除成功返回没有删除成功的id</SPAN>
        # <UL>
        # <LI>
