...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 为ISV提供可以唤醒主客的二维码服务</SPAN>
# <UL>
# </UL>
class WirelessQrcodeGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">二维码图片地址</SPAN>
        # <UL>
        # <LI>
