...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 修改某个用户订阅的天猫退款的信息。 可以追加某个事件订阅也可以去掉某个事件订阅。 体现在参数action 里面: 0:取消订阅;1:订阅。</SPAN>
# <UL>
# </UL>
class MallEaiOrderRegisterResponse(object):
