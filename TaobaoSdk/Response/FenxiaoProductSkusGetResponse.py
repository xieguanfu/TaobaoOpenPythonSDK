...
from Domain.FenxiaoSku import FenxiaoSku

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 产品sku查询</SPAN>
# <UL>
# </UL>
class FenxiaoProductSkusGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">sku信息</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">记录数量</SPAN>
        # <UL>
        # <LI>
