...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广组下的词效果报表数据查询(明细数据不分类型查询)</SPAN>
# <UL>
# </UL>
class SimbaRptAdgroupkeywordeffectGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">词效果数据返回结果</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.rpt_adgroupkeyword_effect_list = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_adgroupkeyword_effect_list": "String",
        }
        levels = {
            
            "rpt_adgroupkeyword_effect_list": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_adgroupkeyword_effect_list"):
            self.rpt_adgroupkeyword_effect_list = self._newInstance("rpt_adgroupkeyword_effect_list", kargs["rpt_adgroupkeyword_effect_list"])
