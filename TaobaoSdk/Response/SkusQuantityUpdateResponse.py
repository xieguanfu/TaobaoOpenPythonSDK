...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 提供按照全量/增量的方式批量修改SKU库存的功能</SPAN>
# <UL>
# </UL>
class SkusQuantityUpdateResponse(object):
