...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分销商或供应商可以查询某子单的退款信息，以及下游订单的退款信息</SPAN>
# <UL>
# </UL>
class FenxiaoRefundGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">退款详情</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("refund_detail"):
            self.refund_detail = self._newInstance("refund_detail", kargs["refund_detail"])
