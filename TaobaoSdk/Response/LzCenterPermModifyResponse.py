...
## @brief 修改一条权限的privilege_name, privilege_level, order_by, privilege_url, privilege_type
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 修改一条权限的privilege_name, privilege_level, order_by, privilege_url, privilege_type</SPAN>
# <UL>
# </UL>
class LzCenterPermModifyResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">success, failure</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("modify_result"):
            self.modify_result = self._newInstance("modify_result", kargs["modify_result"])
