...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 买家可以将自己“未使用”状态下的优惠券转发给任意淘宝用户。 只能转发“未使用”状态下的优惠券</SPAN>
# <UL>
# </UL>
class PromotionCouponTransferResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">false代表失败，true代表成功</SPAN>
        # <UL>
        # <LI>
