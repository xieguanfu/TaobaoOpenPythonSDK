...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 供应商更新合作的分销商等级</SPAN>
# <UL>
# </UL>
class FenxiaoCooperationUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">更新结果成功失败</SPAN>
        # <UL>
        # <LI>
