...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据城市获取该城市当天的生活服务类商品</SPAN>
# <UL>
# </UL>
class JuCitygroupGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">生活服务团信息</SPAN>
        # <UL>
        # <LI>
