...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询卖家是否支持返利</SPAN>
# <UL>
# </UL>
class TaobaokeRebateAuthorizeGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">卖家是否同意返利.true:同意返利,false:拒绝返利</SPAN>
        # <UL>
        # <LI>
