...
from Domain.TypeVO import TypeVO



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 只能根据ID或者名称查询类型  <b>不会返回类型下面关联的属性列表</b>，如果需要得到类型下面的属性列表，需要调用queryAttribute方法<br></SPAN>
# <UL>
# </UL>
class HanoiTypesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">分页返回信息</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回的类型列表信息。</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TypeVO</SPAN>
        # </LI>
        # <LI>
