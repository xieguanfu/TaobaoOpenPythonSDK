...
from Domain.AttributeVO import AttributeVO



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: * 1、查询属性时，<b>只能查询Attribute的简单信息</b>，不会级联任何表结构从而得到其他对象，如果需要用到其他对象，请从其他接口获得 	 * 2、属性的必填参数分两种，一种是随模板一起传入，这种必填参数创建模板时必须赋值Value</SPAN>
# <UL>
# </UL>
class HanoiAttributesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回查询的属性列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">AttributeVO</SPAN>
        # </LI>
        # <LI>
