...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据淘宝后台类目的一级类目和叶子类目</SPAN>
# <UL>
# </UL>
class TraderateImprImprwordsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回类目下所有大家印象的标签</SPAN>
        # <UL>
        # <LI>
