...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过营销积木id列表来获取营销积木块列表。</SPAN>
# <UL>
# </UL>
class UmpMbbsListGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">营销积木块内容列表，内容为json格式的，可以通过ump sdk里面的MBB.fromJson来处理</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("mbbs"):
            self.mbbs = self._newInstance("mbbs", kargs["mbbs"])
