...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据一个关键词Id列表取得一组关键词</SPAN>
# <UL>
# </UL>
class SimbaKeywordsbykeywordidsGetResponse(object):
