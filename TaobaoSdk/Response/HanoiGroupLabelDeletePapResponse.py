...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除分组中的一个标签，自动审核</SPAN>
# <UL>
# </UL>
class HanoiGroupLabelDeletePapResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">修改成功结果</SPAN>
        # <UL>
        # <LI>
