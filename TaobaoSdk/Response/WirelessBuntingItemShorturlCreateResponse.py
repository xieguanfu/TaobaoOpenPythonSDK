...
## @brief 通过商品id生成短链，用户点击短链后直接跳转手淘客户端，未安装则跳转下载页
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过商品id生成短链，用户点击短链后直接跳转手淘客户端，未安装则跳转下载页</SPAN>
# <UL>
# </UL>
class WirelessBuntingItemShorturlCreateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">短地址</SPAN>
        # <UL>
        # <LI>
