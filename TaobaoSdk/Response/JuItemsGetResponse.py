...
## @brief 根据商品id列表获取商品列表，目前一次最多返回6条。传入的参数id列表超过6条也只返回前6条的商品
...
from Domain.ItemData import ItemData



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据商品id列表获取商品列表，目前一次最多返回6条。传入的参数id列表超过6条也只返回前6条的商品</SPAN>
# <UL>
# </UL>
class JuItemsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">聚划算商品对象列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ItemData</SPAN>
        # </LI>
        # <LI>
