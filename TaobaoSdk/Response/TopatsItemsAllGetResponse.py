...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 提供异步获取三个月内的所有（出售中和仓库中）商品详情信息接口。</SPAN>
# <UL>
# </UL>
class TopatsItemsAllGetResponse(object):
