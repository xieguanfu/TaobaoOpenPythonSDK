...
from Domain.ModularDescInfo import ModularDescInfo



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商品描述模块信息获取，包括运营设定的类目级别的模块信息以及用户自定义模块数量约束。</SPAN>
# <UL>
# </UL>
class MallItemDescModulesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回描述模块信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ModularDescInfo</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "modular_desc_info": "ModularDescInfo",
        }
        levels = {
            
            "modular_desc_info": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("modular_desc_info"):
            self.modular_desc_info = self._newInstance("modular_desc_info", kargs["modular_desc_info"])
