...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据sku properties删除sku数据</SPAN>
# <UL>
# </UL>
class FenxiaoProductSkuDeleteResponse(object):
