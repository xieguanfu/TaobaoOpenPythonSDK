...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广组下的定向推广基础数据查询</SPAN>
# <UL>
# </UL>
class SimbaRptAdgroupnonsearchbaseGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">非搜索推广组基础对象</SPAN>
        # <UL>
        # <LI>
