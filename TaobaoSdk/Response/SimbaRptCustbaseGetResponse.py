...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 客户账户报表基础数据对象</SPAN>
# <UL>
# </UL>
class SimbaRptCustbaseGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">用户帐户结果</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_cust_base_list": "String",
        }
        levels = {
            
            "rpt_cust_base_list": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_cust_base_list"):
            self.rpt_cust_base_list = self._newInstance("rpt_cust_base_list", kargs["rpt_cust_base_list"])
