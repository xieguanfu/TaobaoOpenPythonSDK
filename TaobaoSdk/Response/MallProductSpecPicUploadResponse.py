...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 上传指定类型的产品规格认证文件，并返回存有上传成功图片url的产品规格对象</SPAN>
# <UL>
# </UL>
class MallProductSpecPicUploadResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">上传成功的产品规格认证图片url</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("spec_pic_url"):
            self.spec_pic_url = self._newInstance("spec_pic_url", kargs["spec_pic_url"])
