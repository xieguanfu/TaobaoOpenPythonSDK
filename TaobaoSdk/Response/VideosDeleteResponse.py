...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 此api用于批量删除视频，删除后的视频无法被搜索，全部删除成功返回成功，不支持部分删除</SPAN>
# <UL>
# </UL>
class VideosDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">全部删除成功返回true，不支持部分删除</SPAN>
        # <UL>
        # <LI>
