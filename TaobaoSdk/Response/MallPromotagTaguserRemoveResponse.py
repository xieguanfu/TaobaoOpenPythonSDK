...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 给用户载体去标</SPAN>
# <UL>
# </UL>
class MallPromotagTaguserRemoveResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">打标结果是否成功</SPAN>
        # <UL>
        # <LI>
