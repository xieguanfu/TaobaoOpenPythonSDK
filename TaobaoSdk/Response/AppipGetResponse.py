...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取ISV发起请求服务器IP</SPAN>
# <UL>
# </UL>
class AppipGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">ISV发起请求服务器IP</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("ip"):
            self.ip = self._newInstance("ip", kargs["ip"])
