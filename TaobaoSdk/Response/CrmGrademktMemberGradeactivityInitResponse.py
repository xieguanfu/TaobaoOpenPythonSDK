...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商家通过该接口设置等级活动</SPAN>
# <UL>
# </UL>
class CrmGrademktMemberGradeactivityInitResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">json格式</SPAN>
        # <UL>
        # <LI>
