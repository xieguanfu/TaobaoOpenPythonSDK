...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询支付宝账单下载地址</SPAN>
# <UL>
# </UL>
class LipayDataBillDownloadurlGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">账单下载地址链接，获取连接后30秒后未下载，链接地址失效。</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("bill_download_url"):
            self.bill_download_url = self._newInstance("bill_download_url", kargs["bill_download_url"])
