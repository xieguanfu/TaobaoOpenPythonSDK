...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建退款留言/凭证</SPAN>
# <UL>
# </UL>
class RefundMessageAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">退款信息。包含id和created</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("refund_message"):
            self.refund_message = self._newInstance("refund_message", kargs["refund_message"])
