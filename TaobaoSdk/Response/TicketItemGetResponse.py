...
## @brief 获取新门票类目商品信息，目前只支持门票二期的商品
...
from Domain.TicketItem import TicketItem



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取新门票类目商品信息，目前只支持门票二期的商品</SPAN>
# <UL>
# </UL>
class TicketItemGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">参见TicketItem数据结构文档</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TicketItem</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("ticket_item"):
            self.ticket_item = self._newInstance("ticket_item", kargs["ticket_item"])
