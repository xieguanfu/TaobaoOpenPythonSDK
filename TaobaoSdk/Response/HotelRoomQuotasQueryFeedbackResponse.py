...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 接入方房态查询结果返回</SPAN>
# <UL>
# </UL>
class HotelRoomQuotasQueryFeedbackResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">接口调用是否成功</SPAN>
        # <UL>
        # <LI>
