...
from Domain.StaffEvalStatOnDay import StaffEvalStatOnDay



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据操作者ID，返回被查者ID指定日期内每个帐号每日的"客服评价统计"  备注：1、如果是操作者ID=被查者ID，返回被查者ID的"客服评价统计"。      2、如果操作者是组管理员，他可以查询他的组中的所有子帐号的"客服评价统计"。      3、如果操作者是主账户，他可以查询所有子帐号的"客服评价统计"。     4、被查者ID可以是多个，用 "," 隔开，id数不能超过30。     5、开始时间与结束时间之间的间隔不能超过7天     6、不能查询90天以前的数据     7、不能查询当天的记录</SPAN>
# <UL>
# </UL>
class WangwangEserviceEvaluationGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">StaffEvalStatOnDay</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "staff_eval_stat_on_days": "StaffEvalStatOnDay",
        }
        levels = {
            
            "staff_eval_stat_on_days": "Object Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("staff_eval_stat_on_days"):
            self.staff_eval_stat_on_days = self._newInstance("staff_eval_stat_on_days", kargs["staff_eval_stat_on_days"])
