...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过该接口，将商品以及SKU上得条形码信息补全</SPAN>
# <UL>
# </UL>
class ItemBarcodeUpdateResponse(object):
