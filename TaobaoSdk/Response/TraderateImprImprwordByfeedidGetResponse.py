...
from Domain.ImprFeedIdDO import ImprFeedIdDO



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据卖家nick和交易id（如果是子订单，输入子订单id），查询到该条评价的大家印象标签</SPAN>
# <UL>
# </UL>
class TraderateImprImprwordByfeedidGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">根据子订单和买家昵称找到的评价和印象词结果</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ImprFeedIdDO</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("impr_feed"):
            self.impr_feed = self._newInstance("impr_feed", kargs["impr_feed"])
