...
from Domain.ServiceItemProperty import ServiceItemProperty



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 淘宝服务属性查询</SPAN>
# <UL>
# </UL>
class TsPropertyGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">服务收费项相关属性对象</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ServiceItemProperty</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.service_item_property = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "service_item_property": "ServiceItemProperty",
        }
        levels = {
            
            "service_item_property": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("service_item_property"):
            self.service_item_property = self._newInstance("service_item_property", kargs["service_item_property"])
