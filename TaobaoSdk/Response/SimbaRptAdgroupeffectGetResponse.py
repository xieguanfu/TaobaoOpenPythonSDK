...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广组效果报表数据对象</SPAN>
# <UL>
# </UL>
class SimbaRptAdgroupeffectGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # </LI>
        # </UL>
        self.rpt_adgroup_effect_list = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_adgroup_effect_list": "String",
        }
        levels = {
            
            "rpt_adgroup_effect_list": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_adgroup_effect_list"):
            self.rpt_adgroup_effect_list = self._newInstance("rpt_adgroup_effect_list", kargs["rpt_adgroup_effect_list"])
