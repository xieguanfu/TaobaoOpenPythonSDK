...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取得一个推广组的所有关键词</SPAN>
# <UL>
# </UL>
class SimbaKeywordsbyadgroupidGetResponse(object):
