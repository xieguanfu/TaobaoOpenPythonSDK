...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询工具列表</SPAN>
# <UL>
# </UL>
class UmpToolsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">工具列表，单个内容为json格式，需要通过ump的sdk提供的MarketingBuilder来进行处理</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tools"):
            self.tools = self._newInstance("tools", kargs["tools"])
