...
## @brief 取得一个推广组的所有关键词和类目出价的质量得分列表
...
from Domain.Qscore import Qscore



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取得一个推广组的所有关键词和类目出价的质量得分列表</SPAN>
# <UL>
# </UL>
class SimbaKeywordscatQscoreGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">类目出价和词的质量得分对象</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Qscore</SPAN>
        # </LI>
        # <LI>
