...
from Domain.ADGroupPage import ADGroupPage



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取得一个推广计划的所有推广组，或者根据一个推广组Id列表取得一组推广组； 如果同时提供了推广计划Id和推广组id列表，则优先使用推广计划Id，当使用 推广计划ID获取数据时，返回的结果是有分页的。如果是用推广组ID列表作查询 则将一次返回所有查询的结果。</SPAN>
# <UL>
# </UL>
class SimbaAdgroupsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">ADGroupPage</SPAN>
        # </LI>
        # <LI>
