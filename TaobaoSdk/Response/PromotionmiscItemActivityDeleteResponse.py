...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除无条件单品优惠活动</SPAN>
# <UL>
# </UL>
class PromotionmiscItemActivityDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否成功删除活动。</SPAN>
        # <UL>
        # <LI>
