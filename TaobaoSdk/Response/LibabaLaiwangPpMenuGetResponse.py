...
## @brief 来往公众平台菜单获取API 获取当前用户创建过的菜单数据.
...
from Domain.LaiwangPPMenu import LaiwangPPMenu



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 来往公众平台菜单获取API 获取当前用户创建过的菜单数据.</SPAN>
# <UL>
# </UL>
class LibabaLaiwangPpMenuGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">所创建菜单的结构化json串数据.</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">LaiwangPPMenu</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("menu"):
            self.menu = self._newInstance("menu", kargs["menu"])
