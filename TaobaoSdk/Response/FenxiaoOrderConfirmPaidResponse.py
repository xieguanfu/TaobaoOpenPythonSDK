...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 供应商确认收款（非支付宝交易）。</SPAN>
# <UL>
# </UL>
class FenxiaoOrderConfirmPaidResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">确认结果成功与否</SPAN>
        # <UL>
        # <LI>
