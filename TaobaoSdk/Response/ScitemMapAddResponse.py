...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建IC商品或分销商品与后端商品的映射关系</SPAN>
# <UL>
# </UL>
class ScitemMapAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">接口调用返回结果信息：商家编码</SPAN>
        # <UL>
        # <LI>
