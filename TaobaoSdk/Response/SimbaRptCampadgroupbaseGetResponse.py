...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 推广计划下的推广组报表基础数据查询(只有汇总数据，无分类类型)</SPAN>
# <UL>
# </UL>
class SimbaRptCampadgroupbaseGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">推广计划下推广组的基础数据列表</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.rpt_campadgroup_base_list = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "rpt_campadgroup_base_list": "String",
        }
        levels = {
            
            "rpt_campadgroup_base_list": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("rpt_campadgroup_base_list"):
            self.rpt_campadgroup_base_list = self._newInstance("rpt_campadgroup_base_list", kargs["rpt_campadgroup_base_list"])
