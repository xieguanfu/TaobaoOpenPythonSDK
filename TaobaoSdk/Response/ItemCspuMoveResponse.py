...
## @brief ISV传入商品和sku与cspu的映射信息，套餐对应sku的映射信息，自动完成达尔文老数据的挂接，返回商品信息
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: ISV传入商品和sku与cspu的映射信息，套餐对应sku的映射信息，自动完成达尔文老数据的挂接，返回商品信息</SPAN>
# <UL>
# </UL>
class ItemCspuMoveResponse(object):
