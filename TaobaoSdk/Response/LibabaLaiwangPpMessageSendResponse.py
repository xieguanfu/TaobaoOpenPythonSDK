...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 来往公众账号1对1消息发送接口</SPAN>
# <UL>
# </UL>
class LibabaLaiwangPpMessageSendResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">issuccess</SPAN>
        # <UL>
        # <LI>
