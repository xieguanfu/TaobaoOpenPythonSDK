...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 添加/修改一条机票政策</SPAN>
# <UL>
# </UL>
class JipiaoPolicyProcessResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">机票政策添加返回状态，true，成功；false，失败</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回政策主键id(机票系统唯一id)</SPAN>
        # <UL>
        # <LI>
