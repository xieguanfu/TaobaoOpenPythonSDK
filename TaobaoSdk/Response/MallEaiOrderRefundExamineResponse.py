...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 退款单审核结果回写，标记前端批量可退款</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundExamineResponse(object):
