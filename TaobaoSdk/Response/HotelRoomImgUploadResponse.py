...
from Domain.RoomImage import RoomImage



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 此接口用于为商品上传商品图片。</SPAN>
# <UL>
# </UL>
class HotelRoomImgUploadResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">RoomImage</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("room_image"):
            self.room_image = self._newInstance("room_image", kargs["room_image"])
