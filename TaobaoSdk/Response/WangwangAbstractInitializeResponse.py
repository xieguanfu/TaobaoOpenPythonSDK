...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 模糊查询服务初始化，只支持json返回</SPAN>
# <UL>
# </UL>
class WangwangAbstractInitializeResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">当ret_code=-1时这个变量才有</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">0或-1表示成功或失败</SPAN>
        # <UL>
        # <LI>
