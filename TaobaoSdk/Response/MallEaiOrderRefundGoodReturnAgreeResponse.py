...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家同意退货</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundGoodReturnAgreeResponse(object):
