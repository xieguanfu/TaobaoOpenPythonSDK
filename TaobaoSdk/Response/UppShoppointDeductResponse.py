...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 业务状态为成功的时候，会扣减掉买家店铺积分，及状态由预扣的冻结状态改为已使用状态；业务状态为失败的时候，会扣解冻买家店铺积分，及状态由预扣的冻结状态改为可使用状态；</SPAN>
# <UL>
# </UL>
class UppShoppointDeductResponse(object):
