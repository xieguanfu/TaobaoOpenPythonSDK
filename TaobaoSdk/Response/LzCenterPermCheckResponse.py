...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 反向校验权限</SPAN>
# <UL>
# </UL>
class LzCenterPermCheckResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">校验结果 success | failure</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("check_result"):
            self.check_result = self._newInstance("check_result", kargs["check_result"])
