...
from Domain.PropertyInputDO import PropertyInputDO



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 针对监管类目品牌关键属性可输入判断逻辑比较复杂，提供简化属性可输入判断的接口，该接口兼容非关键属性和非监管类目品牌</SPAN>
# <UL>
# </UL>
class MallBrandcatPropinputGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">属性输入特征</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">PropertyInputDO</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "property_input": "PropertyInputDO",
        }
        levels = {
            
            "property_input": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("property_input"):
            self.property_input = self._newInstance("property_input", kargs["property_input"])
