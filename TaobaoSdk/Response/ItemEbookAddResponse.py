...
## @brief 调用该接口 会创建一个普通的电子书商品（必须要有ISBN）
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 调用该接口 会创建一个普通的电子书商品（必须要有ISBN）</SPAN>
# <UL>
# </UL>
class ItemEbookAddResponse(object):
