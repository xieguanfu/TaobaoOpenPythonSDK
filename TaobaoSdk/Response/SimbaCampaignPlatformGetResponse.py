...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取得一个推广计划的投放平台设置</SPAN>
# <UL>
# </UL>
class SimbaCampaignPlatformGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">取得的推广计划的投放平台设置</SPAN>
        # <UL>
        # <LI>
