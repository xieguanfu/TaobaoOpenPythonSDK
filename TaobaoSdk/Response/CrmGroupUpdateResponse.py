...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 修改一个已经存在的分组，接口返回分组的修改是否成功</SPAN>
# <UL>
# </UL>
class CrmGroupUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">分组修改是否成功</SPAN>
        # <UL>
        # <LI>
