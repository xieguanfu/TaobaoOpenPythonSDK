...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 供应商修改经销采购单备注</SPAN>
# <UL>
# </UL>
class FenxiaoDealerRequisitionorderRemarkUpdateResponse(object):
