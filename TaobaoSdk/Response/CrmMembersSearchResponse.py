...
from Domain.CrmMember import CrmMember

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 会员列表的高级查询，接口返回符合条件的会员列表.<br> 注：建议获取09年以后的数据，09年之前的数据不是很完整</SPAN>
# <UL>
# </UL>
class CrmMembersSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">根据一定条件查询的卖家会员</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">CrmMember</SPAN>
        # </LI>
        # <LI>
