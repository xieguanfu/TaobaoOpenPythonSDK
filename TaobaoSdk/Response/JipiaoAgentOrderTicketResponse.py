...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 淘宝机票代理商回填票号/成功订单</SPAN>
# <UL>
# </UL>
class JipiaoAgentOrderTicketResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">失败时的错误信息</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回接口调用完成后，整个订单是否成功</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.is_order_success = None
        
        
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回操作成功失败信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Boolean</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回回填票号操作成功失败信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Boolean</SPAN>
        # </LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "is_ticket_success": "Boolean",
        }
        levels = {
            
            "error_message": "Basic",
            
            "is_order_success": "Basic",
            
            "is_success": "Basic",
            
            "is_ticket_success": "Basic",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("is_order_success"):
            self.is_order_success = self._newInstance("is_order_success", kargs["is_order_success"])
        
        if kargs.has_key("is_success"):
            self.is_success = self._newInstance("is_success", kargs["is_success"])
        
        if kargs.has_key("is_ticket_success"):
            self.is_ticket_success = self._newInstance("is_ticket_success", kargs["is_ticket_success"])
