...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 调用function</SPAN>
# <UL>
# </UL>
class HanoiFunctionExecuteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">function执行结果。根据action不同而不同。使用SimpleResult封装，target通常为true或false</SPAN>
        # <UL>
        # <LI>
