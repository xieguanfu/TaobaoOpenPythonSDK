...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取图片分类信息</SPAN>
# <UL>
# </UL>
class PictureCategoryGetResponse(object):
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "picture_categories": "PictureCategory",
        }
        levels = {
            
            "picture_categories": "Object Array",
        }
