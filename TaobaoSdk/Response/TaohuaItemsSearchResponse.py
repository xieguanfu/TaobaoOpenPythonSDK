...
from Domain.TaohuaSearchItems import TaohuaSearchItems



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商品搜索列表接口</SPAN>
# <UL>
# </UL>
class TaohuaItemsSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">商品搜索列表数据结构</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TaohuaSearchItems</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "search_items_result": "TaohuaSearchItems",
        }
        levels = {
            
            "search_items_result": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("search_items_result"):
            self.search_items_result = self._newInstance("search_items_result", kargs["search_items_result"])
