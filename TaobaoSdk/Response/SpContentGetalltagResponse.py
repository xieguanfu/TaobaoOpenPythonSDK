...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取所有的自定义标签</SPAN>
# <UL>
# </UL>
class SpContentGetalltagResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回JSON格式的TagName列表</SPAN>
        # <UL>
        # <LI>
