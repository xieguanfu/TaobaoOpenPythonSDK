...
from Domain.Creative import Creative



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除一个创意</SPAN>
# <UL>
# </UL>
class SimbaCreativeDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">被删除的创意对象</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("creative"):
            self.creative = self._newInstance("creative", kargs["creative"])
