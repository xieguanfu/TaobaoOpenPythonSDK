...
from Domain.CreateResult import CreateResult



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 外卖单张图片上传接口</SPAN>
# <UL>
# </UL>
class WaimaiItemPicUploadResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回图片地址及提示信息及code. 返回结果result_data为完整图片地址,例如: http://img.taobaocdn.com/bao/uploaded/i1/T1uTCUXExiXXcK5RZ8</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">CreateResult</SPAN>
        # </LI>
        # <LI>
