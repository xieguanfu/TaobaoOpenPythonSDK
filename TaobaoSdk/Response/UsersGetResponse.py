...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 传入多个淘宝会员帐号返回多个用户公开信息</SPAN>
# <UL>
# </UL>
class UsersGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">用户信息列表</SPAN>
        # <UL>
        # <LI>
