...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 清空活动参与的商品</SPAN>
# <UL>
# </UL>
class PromotionmiscActivityRangeAllRemoveResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">清空活动参与商品是否成功。</SPAN>
        # <UL>
        # <LI>
