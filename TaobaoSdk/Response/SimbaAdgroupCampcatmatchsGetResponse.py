...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据一个推广计划的id获取一页推广组类目出价列表</SPAN>
# <UL>
# </UL>
class SimbaAdgroupCampcatmatchsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">一页推广组类目出价列表</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "adgroupcatmatchs": "ADGroupCatMatchPage",
        }
        levels = {
            
            "adgroupcatmatchs": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("adgroupcatmatchs"):
            self.adgroupcatmatchs = self._newInstance("adgroupcatmatchs", kargs["adgroupcatmatchs"])
