...
from Domain.AuthorizeMessage import AuthorizeMessage

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: taobao.increment.authorizemessages.get</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class IncrementAuthorizemessagesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">用户授权信息列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">AuthorizeMessage</SPAN>
        # </LI>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.authorize_messages = None
        ''' 
        @ivar authorize_messages: 用户授权信息列表; B{Level}: C{Object Array}; B{Required}: C{true}; B{Sample}: C{};
        @type authorize_messages: AuthorizeMessage
        '''
        ...
        ''' 
        @ivar total_results: 符合条件的结果总数; B{Level}: C{Basic}; B{Required}: C{true}; B{Sample}: C{1};
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "authorize_messages": "AuthorizeMessage",
            
            "total_results": "Number",
        }
        levels = {
            
            "authorize_messages": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("authorize_messages"):
            self.authorize_messages = self._newInstance("authorize_messages", kargs["authorize_messages"])
