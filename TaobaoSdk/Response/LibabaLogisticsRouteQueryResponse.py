...
from Domain.QueryRouteResult import QueryRouteResult



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据始发地，目的地等条件查询线路的分页列表</SPAN>
# <UL>
# </UL>
class LibabaLogisticsRouteQueryResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">QueryRouteResult</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "query_route_result": "QueryRouteResult",
        }
        levels = {
            
            "query_route_result": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("query_route_result"):
            self.query_route_result = self._newInstance("query_route_result", kargs["query_route_result"])
