...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 和创建标签类似，区别在于自动审核，可立即使用</SPAN>
# <UL>
# </UL>
class HanoiLabelAddPapResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">创建标签成功后，返回的Id</SPAN>
        # <UL>
        # <LI>
