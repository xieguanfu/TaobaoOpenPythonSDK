...
from Domain.EbookOrder import EbookOrder

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分页查询卖家赠送电子书的订单信息。</SPAN>
# <UL>
# </UL>
class EbookOrderSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">EbookOrder</SPAN>
        # </LI>
        # <LI>
