...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 异步删除rds库数据推送表的数据</SPAN>
# <UL>
# </UL>
class TopatsJushitaJdpDatadeleteResponse(object):
