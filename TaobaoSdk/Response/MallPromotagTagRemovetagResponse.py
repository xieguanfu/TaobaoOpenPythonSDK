...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用于删除标签定义，但是要确保目前该标签没有人群在使用。</SPAN>
# <UL>
# </UL>
class MallPromotagTagRemovetagResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">删除操作是否成功</SPAN>
        # <UL>
        # <LI>
