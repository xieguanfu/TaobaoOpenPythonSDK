...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据用户ID获取用户下所有模板</SPAN>
# <UL>
# </UL>
class DeliveryTemplatesGetResponse(object):
    ...
    def _getPropertyType(self, name):
        ...
        levels = {
            ...
            "delivery_templates": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("delivery_templates"):
            self.delivery_templates = self._newInstance("delivery_templates", kargs["delivery_templates"])
