...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 调用该接口 会修改一个普通的电子书（含ISBN）商品</SPAN>
# <UL>
# </UL>
class ItemEbookUpdateResponse(object):
