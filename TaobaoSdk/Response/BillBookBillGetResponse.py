...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询单笔虚拟账户明细</SPAN>
# <UL>
# </UL>
class BillBookBillGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">虚拟账户账单</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("bookbill"):
            self.bookbill = self._newInstance("bookbill", kargs["bookbill"])
