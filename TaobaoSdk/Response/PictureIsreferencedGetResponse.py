...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询图片是否被引用，被引用返回true，未被引用返回false</SPAN>
# <UL>
# </UL>
class PictureIsreferencedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">图片是否被引用</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("is_referenced"):
            self.is_referenced = self._newInstance("is_referenced", kargs["is_referenced"])
