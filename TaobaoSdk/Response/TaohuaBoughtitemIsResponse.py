...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 判断用户是否购买过该商品</SPAN>
# <UL>
# </UL>
class TaohuaBoughtitemIsResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回结果，true代表该商品已经被购买过，false代表该商品还没有被购买过</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("is_bought"):
            self.is_bought = self._newInstance("is_bought", kargs["is_bought"])
