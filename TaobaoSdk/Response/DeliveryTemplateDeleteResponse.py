...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据用户指定的模板ID删除指定的模板</SPAN>
# <UL>
# </UL>
class DeliveryTemplateDeleteResponse(object):
