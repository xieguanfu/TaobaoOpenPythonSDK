...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 开通主动通知业务的APP可以通过该接口获取商品变更通知信息 <font color="red">建议获取增量消息的时间间隔是：半个小时</font></SPAN>
# <UL>
# </UL>
