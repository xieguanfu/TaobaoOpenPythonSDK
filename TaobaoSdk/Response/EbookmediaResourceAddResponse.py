...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 为电子书添加资源文件入口</SPAN>
# <UL>
# </UL>
class EbookmediaResourceAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否修改成功</SPAN>
        # <UL>
        # <LI>
