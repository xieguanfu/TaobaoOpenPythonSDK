...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取消物流宝外部订单TOP接口</SPAN>
# <UL>
# </UL>
class WlbExtorderCancleResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">修改时间，只有在取消成功的情况下，才有效</SPAN>
        # <UL>
        # <LI>
