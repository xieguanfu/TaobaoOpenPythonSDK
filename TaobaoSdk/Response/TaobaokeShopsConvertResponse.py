...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 淘宝客店铺转换</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class TaobaokeShopsConvertResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ''' 
        @ivar taobaoke_shops: 淘宝客店铺对象列表,不能返回shop_type,seller_credit,auction_coun,
total_auction; B{Level}: C{Object Array}; B{Required}: C{true}; B{Sample}: C{};
        @type taobaoke_shops: TaobaokeShop
        '''
