...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取消某个权限</SPAN>
# <UL>
# </UL>
class LzCenterPermCancelResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">取消成功：success; 取消失败:failure</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("cancel_result"):
            self.cancel_result = self._newInstance("cancel_result", kargs["cancel_result"])
