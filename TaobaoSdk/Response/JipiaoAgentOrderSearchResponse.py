...
from Domain.SearchOrderResult import SearchOrderResult



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家根据条件查询淘宝订单id列表</SPAN>
# <UL>
# </UL>
class JipiaoAgentOrderSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">机票订单搜索返回结果对象</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">SearchOrderResult</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "search_result": "SearchOrderResult",
        }
        levels = {
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("search_result"):
            self.search_result = self._newInstance("search_result", kargs["search_result"])
