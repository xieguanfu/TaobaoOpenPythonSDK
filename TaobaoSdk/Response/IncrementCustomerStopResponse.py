...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 供应用关闭其用户的增量消息服务功能，这样可以节省ISV的流量。</SPAN>
# <UL>
# </UL>
class IncrementCustomerStopResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">关闭增量消息或数据同步是否成功</SPAN>
        # <UL>
        # <LI>
