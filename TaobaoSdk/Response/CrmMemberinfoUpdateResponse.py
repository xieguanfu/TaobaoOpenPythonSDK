...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 编辑会员的基本资料，接口返回会员信息修改是否成功</SPAN>
# <UL>
# </UL>
class CrmMemberinfoUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">会员信息修改是否成功</SPAN>
        # <UL>
        # <LI>
