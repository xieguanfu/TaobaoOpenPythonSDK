...
## @brief 根据终端类型和平台ID，分页获取聚划算商品id列表
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据终端类型和平台ID，分页获取聚划算商品id列表</SPAN>
# <UL>
# </UL>
class JuItemidsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回的商品ID列表</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("item_ids"):
            self.item_ids = self._newInstance("item_ids", kargs["item_ids"])
