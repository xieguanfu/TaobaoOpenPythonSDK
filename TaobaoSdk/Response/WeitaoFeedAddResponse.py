...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过top接口发表微淘Feed</SPAN>
# <UL>
# </UL>
class WeitaoFeedAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">发布feed成功后返回的feedId</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("feed_id"):
            self.feed_id = self._newInstance("feed_id", kargs["feed_id"])
