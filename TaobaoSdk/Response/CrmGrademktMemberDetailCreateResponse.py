...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建商品等级营销明细</SPAN>
# <UL>
# </UL>
class CrmGrademktMemberDetailCreateResponse(object):
