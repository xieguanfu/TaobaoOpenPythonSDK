...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取登陆权限签名</SPAN>
# <UL>
# </UL>
class SimbaLoginAuthsignGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">登陆签名</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("subway_token"):
            self.subway_token = self._newInstance("subway_token", kargs["subway_token"])
