...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据推荐类型获取推荐的关联关系商品</SPAN>
# <UL>
# </UL>
class ItemrecommendItemsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回的推荐商品列表结果集</SPAN>
        # <UL>
        # <LI>
