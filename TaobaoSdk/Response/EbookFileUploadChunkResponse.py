...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 上传电子书文件块</SPAN>
# <UL>
# </UL>
class EbookFileUploadChunkResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">文件ID</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("file_id"):
            self.file_id = self._newInstance("file_id", kargs["file_id"])
