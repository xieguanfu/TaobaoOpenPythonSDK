...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询宝贝详情，可根据入参获取需要的字段</SPAN>
# <UL>
# </UL>
class WaimaiItemGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">外卖宝贝详情</SPAN>
        # <UL>
        # <LI>
