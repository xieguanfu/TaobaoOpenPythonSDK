...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 新增优惠工具。通过ump sdk来完成将积木块拼装成为工具的操作，再使用本接口上传优惠工具。</SPAN>
# <UL>
# </UL>
class UmpToolAddResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tool_id"):
            self.tool_id = self._newInstance("tool_id", kargs["tool_id"])
