...
from Domain.EbookYunpanToken import EbookYunpanToken



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取云盘的token信息</SPAN>
# <UL>
# </UL>
class EbookYunpanTokenGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">访问云盘的token信息</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">EbookYunpanToken</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "ebook_yunpan_token": "EbookYunpanToken",
        }
        levels = {
            
            "ebook_yunpan_token": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("ebook_yunpan_token"):
            self.ebook_yunpan_token = self._newInstance("ebook_yunpan_token", kargs["ebook_yunpan_token"])
