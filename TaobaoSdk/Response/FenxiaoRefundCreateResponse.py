...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 用于对分销的子采购单创建退款</SPAN>
# <UL>
# </UL>
class FenxiaoRefundCreateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">退款是否创建成功</SPAN>
        # <UL>
        # <LI>
