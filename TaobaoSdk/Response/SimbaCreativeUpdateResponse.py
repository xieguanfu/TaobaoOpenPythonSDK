...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新一个创意的信息，可以设置创意标题、创意图片</SPAN>
# <UL>
# </UL>
class SimbaCreativeUpdateResponse(object):
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("creativerecord"):
            self.creativerecord = self._newInstance("creativerecord", kargs["creativerecord"])
