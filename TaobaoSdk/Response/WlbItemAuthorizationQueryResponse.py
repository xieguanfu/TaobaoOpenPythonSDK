...
from Domain.WlbAuthorization import WlbAuthorization

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询授权关系,可由货主或被授权人查询。</SPAN>
# <UL>
# </UL>
class WlbItemAuthorizationQueryResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">授权关系列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">WlbAuthorization</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "authorization_list": "WlbAuthorization",
            
            "total_count": "Number",
        }
        levels = {
            
            "authorization_list": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("authorization_list"):
            self.authorization_list = self._newInstance("authorization_list", kargs["authorization_list"])
