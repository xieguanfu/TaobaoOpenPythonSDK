...
from Domain.UserTag import UserTag



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询人群标签，返回卖家创建的全部人群标签（有效的）</SPAN>
# <UL>
# </UL>
class MarketingTagsGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">UserTag</SPAN>
        # </LI>
        # <LI>
