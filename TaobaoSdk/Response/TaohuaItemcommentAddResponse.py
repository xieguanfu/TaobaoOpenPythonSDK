...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 对指定商品发表评论</SPAN>
# <UL>
# </UL>
class TaohuaItemcommentAddResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">发表评论成功标志</SPAN>
        # <UL>
        # <LI>
