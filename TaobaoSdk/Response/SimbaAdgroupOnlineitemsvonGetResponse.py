...
from Domain.SubwayItemPartition import SubwayItemPartition
...
# <UL>
# </UL>
class SimbaAdgroupOnlineitemsvonGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">SubwayItemPartition</SPAN>
        # </LI>
        # <LI>
