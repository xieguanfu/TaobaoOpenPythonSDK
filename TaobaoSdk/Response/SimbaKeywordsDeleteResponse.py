...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 删除一批关键词</SPAN>
# <UL>
# </UL>
class SimbaKeywordsDeleteResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">成功删除的关键词列表</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("keywords"):
            self.keywords = self._newInstance("keywords", kargs["keywords"])
