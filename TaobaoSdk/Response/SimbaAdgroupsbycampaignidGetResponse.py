...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 批量得到推广计划下的推广组</SPAN>
# <UL>
# </UL>
class SimbaAdgroupsbycampaignidGetResponse(object):
