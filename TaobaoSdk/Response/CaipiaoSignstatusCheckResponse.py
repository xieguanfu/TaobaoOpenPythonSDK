...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 检查用户是否签署了支付宝代扣协议。如果签署了，返回true; 如果没签署，返回false, 同时返回签署代扣协议的Url。</SPAN>
# <UL>
# </UL>
class CaipiaoSignstatusCheckResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否签署了支付宝代扣协议</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">签署支付宝代扣协议的Url</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("sign"):
            self.sign = self._newInstance("sign", kargs["sign"])
        
        if kargs.has_key("sign_url"):
            self.sign_url = self._newInstance("sign_url", kargs["sign_url"])
