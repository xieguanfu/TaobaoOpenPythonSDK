...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 保存卖家选择的活动赠送商品的信息。</SPAN>
# <UL>
# </UL>
class EbookActivityItemInputResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否操作成功</SPAN>
        # <UL>
        # <LI>
