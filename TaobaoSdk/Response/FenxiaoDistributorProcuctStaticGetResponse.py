...
from Domain.DistributorItemFlow import DistributorItemFlow

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取分销商品流量，以天为单位统计分销商品的PV，UV</SPAN>
# <UL>
# </UL>
class FenxiaoDistributorProcuctStaticGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">分销商商品流量</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">DistributorItemFlow</SPAN>
        # </LI>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Level</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Object Array</SPAN>
        # </LI>
        # </UL>
        self.distributor_item_flows = None
        
        
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">执行结果，true表示执行成功；false表示执行失败。</SPAN>
        # <UL>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "distributor_item_flows": "DistributorItemFlow",
            
            "is_success": "Boolean",
        }
        levels = {
            
            "distributor_item_flows": "Object Array",
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("distributor_item_flows"):
            self.distributor_item_flows = self._newInstance("distributor_item_flows", kargs["distributor_item_flows"])
