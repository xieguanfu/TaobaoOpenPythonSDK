...
from Domain.TaohuaUpdateInfo import TaohuaUpdateInfo



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取最新更新信息</SPAN>
# <UL>
# </UL>
class TaohuaLatestupdateinfoGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">更新信息版本号</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TaohuaUpdateInfo</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "taohua_update_info": "TaohuaUpdateInfo",
        }
        levels = {
            
            "taohua_update_info": "Object",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("taohua_update_info"):
            self.taohua_update_info = self._newInstance("taohua_update_info", kargs["taohua_update_info"])
