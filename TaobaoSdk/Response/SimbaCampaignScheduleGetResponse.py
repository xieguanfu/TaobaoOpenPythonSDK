...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 取得一个推广计划的分时折扣设置</SPAN>
# <UL>
# </UL>
class SimbaCampaignScheduleGetResponse(object):
