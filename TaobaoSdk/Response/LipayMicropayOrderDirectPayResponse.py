...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 1.	创建并支付一笔冻结金后，调用此接口 2.	这个接口调用的前提是创建冻结金的参数信息pay_confirm=NO_CONFIRM</SPAN>
# <UL>
# </UL>
class LipayMicropayOrderDirectPayResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">单笔直接支付返回结果</SPAN>
        # <UL>
        # <LI>
