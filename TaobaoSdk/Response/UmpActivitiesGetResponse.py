...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询活动列表</SPAN>
# <UL>
# </UL>
class UmpActivitiesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">营销活动内容，可以通过ump sdk来进行处理</SPAN>
        # <UL>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("contents"):
            self.contents = self._newInstance("contents", kargs["contents"])
