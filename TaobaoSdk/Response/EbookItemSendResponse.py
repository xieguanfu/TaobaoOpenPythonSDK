...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 卖家给买家赠送电子书。赠送成功，返回true；以下情况返回false，例如：参数不符合要求、卖家或买家不存在、卖家未签署支付宝代扣协议等等。</SPAN>
# <UL>
# </UL>
class EbookItemSendResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否赠送成功</SPAN>
        # <UL>
        # <LI>
