...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取修改的推广组ID</SPAN>
# <UL>
# </UL>
class SimbaAdgroupidsChangedGetResponse(object):
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "changed_adgroupids": "Number",
        }
        levels = {
            
            "changed_adgroupids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("changed_adgroupids"):
            self.changed_adgroupids = self._newInstance("changed_adgroupids", kargs["changed_adgroupids"])
