...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 更新外卖店营业规则</SPAN>
# <UL>
# </UL>
class WaimaiShopBusinessrulesUpdateResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">成功：0，失败：1</SPAN>
        # <UL>
        # <LI>
