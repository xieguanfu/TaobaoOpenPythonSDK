...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 商家通过该接口查询等级营销活动</SPAN>
# <UL>
# </UL>
class CrmGrademktMemberDetailQueryResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">totalCount为记录总数</SPAN>
        # <UL>
        # <LI>
