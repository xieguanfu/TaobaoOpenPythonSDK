...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 追加授权产品线</SPAN>
# <UL>
# </UL>
class FenxiaoCooperationProductcatAddResponse(object):
