...
from Domain.EbookItem import EbookItem

    

## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据活动书库ID分页查询书库的商品信息。</SPAN>
# <UL>
# </UL>
class EbookItemsSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">EbookItem</SPAN>
        # </LI>
        # <LI>
