...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: * 获取单个邮费模板 * postage_id对应的邮费模板要属于nick所对应的用户  Q：是否必须是模板所有者才能够使用这个接口? A： 不是的,只要给出了邮费模板id和创建者的昵称就可以使用</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class PostageGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">运费模板</SPAN>
        # <UL>
        # <LI>
        ...
        self.postage = None
        ''' 
        @ivar postage: 运费模板; B{Level}: C{Object}; B{Required}: C{true}; B{Sample}: C{};
