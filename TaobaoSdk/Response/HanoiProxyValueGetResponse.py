...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 通过代理方法获取属性数据，主要是结构化评价和dsr。</SPAN>
# <UL>
# </UL>
class HanoiProxyValueGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">结构化数据</SPAN>
        # <UL>
        # <LI>
