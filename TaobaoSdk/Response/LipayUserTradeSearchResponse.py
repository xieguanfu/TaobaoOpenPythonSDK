...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 查询支付宝账户交易记录</SPAN>
# <UL>
# </UL>
class LipayUserTradeSearchResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">总页数</SPAN>
        # <UL>
        # <LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">交易记录列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">TradeRecord</SPAN>
        # </LI>
        # <LI>
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("total_pages"):
            self.total_pages = self._newInstance("total_pages", kargs["total_pages"])
        
        if kargs.has_key("total_results"):
            self.total_results = self._newInstance("total_results", kargs["total_results"])
        
        if kargs.has_key("trade_records"):
            self.trade_records = self._newInstance("trade_records", kargs["trade_records"])
