...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 分页获取修改的推广组ID和修改时间</SPAN>
# <UL>
# </UL>
class SimbaAdgroupsChangedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">推广组分页对象</SPAN>
        # <UL>
        # <LI>
