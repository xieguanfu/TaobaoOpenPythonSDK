...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 判断用户pid是否是appkey关联的注册用户</SPAN>
# <UL>
# <LI>
...
# </LI>
# </UL>
class TaobaokeToolRelationResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">返回true或false表示是否关联用户</SPAN>
        # <UL>
        # <LI>
        ...
        # </LI>
        # </UL>
        self.tools_user = None
        ''' 
        @ivar tools_user: 返回true或false表示是否关联用户; B{Level}: C{Basic}; B{Required}: C{true}; B{Sample}: C{true};
        @type tools_user: Boolean
        '''
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("tools_user"):
            self.tools_user = self._newInstance("tools_user", kargs["tools_user"])
        pass
