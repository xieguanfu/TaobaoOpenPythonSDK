...
from Domain.RangeVO import RangeVO



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 档案ID必填字段 1、查询值域信息，根据值域ID查询，最多返回一条记录，不会返回分页信息。<br> 	 * 2、根据档案ID查询，默认返回10条记录<br> 	 * 3、值域Key只能配合档案ID来唯一确定一条记录，不会返回分页信息。<br></SPAN>
# <UL>
# </UL>
class HanoiRangesGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">取值范围列表</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">RangeVO</SPAN>
        # </LI>
        # <LI>
