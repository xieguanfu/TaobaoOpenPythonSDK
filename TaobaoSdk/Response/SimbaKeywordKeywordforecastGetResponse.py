...
from Domain.KeywordForecast import KeywordForecast



## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 根据词ID和给定的出价获取词的预估信息</SPAN>
# <UL>
# </UL>
class SimbaKeywordKeywordforecastGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">KeywordForecast</SPAN>
        # </LI>
        # <LI>
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "keyword_forecast": "KeywordForecast",
        }
        levels = {
            
            "keyword_forecast": "Object",
        }
