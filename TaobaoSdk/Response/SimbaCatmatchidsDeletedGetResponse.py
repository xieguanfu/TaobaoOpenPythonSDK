...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 获取删除的类目出价ID</SPAN>
# <UL>
# </UL>
class SimbaCatmatchidsDeletedGetResponse(object):
    def __init__(self, kargs=dict()):
        ...
        # </LI>
        # </UL>
        self.deleted_catmatch_ids = None
    ...
    def _getPropertyType(self, name):
        properties = {
            ...
            "deleted_catmatch_ids": "Number",
        }
        levels = {
            
            "deleted_catmatch_ids": "Basic Array",
        }
    ...
    def __init(self, kargs):
        ...
        if kargs.has_key("deleted_catmatch_ids"):
            self.deleted_catmatch_ids = self._newInstance("deleted_catmatch_ids", kargs["deleted_catmatch_ids"])
