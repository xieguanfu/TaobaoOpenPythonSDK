...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">Response: 创建一个标签分组，自动审核</SPAN>
# <UL>
# </UL>
class HanoiGroupAddPapResponse(object):
    def __init__(self, kargs=dict()):
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">创建成功，返回分组的id</SPAN>
        # <UL>
        # <LI>
