...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">淘客店铺转换。</SPAN>
# <UL>
# </UL>
class TbkShopsConvertRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.tbk.shops.convert"
