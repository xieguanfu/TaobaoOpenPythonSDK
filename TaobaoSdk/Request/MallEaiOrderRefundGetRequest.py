...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">查询单笔退款单</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundGetRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "tmall.eai.order.refund.get"
