...
## @brief 编辑新门票类目商品<br> 只有如下两种情况能够更换门票商品挂载的产品：从其他类目迁移到当前新门票类目，或当前商品挂载的产品被屏蔽<br> 注意门票商品必须发布到对应达尔文体系下的产品上，产品获取请走taobao.products.search接口。 门票商品的产品规格信息包含门票商品的价格，库存，有效期等。是门票核心信息。一个门票宝贝可能包含多个达尔文体系产品（产品对应达尔文体系产品的获取请走tmall.product.specs.get接口），可以指定每个达尔文体系产品在不同时间段下不同有效期的门票的不同价格和库存。具体信息请参见skus字段描述。
...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">编辑新门票类目商品<br> 只有如下两种情况能够更换门票商品挂载的产品：从其他类目迁移到当前新门票类目，或当前商品挂载的产品被屏蔽<br> 注意门票商品必须发布到对应达尔文体系下的产品上，产品获取请走taobao.products.search接口。 门票商品的产品规格信息包含门票商品的价格，库存，有效期等。是门票核心信息。一个门票宝贝可能包含多个达尔文体系产品（产品对应达尔文体系产品的获取请走tmall.product.specs.get接口），可以指定每个达尔文体系产品在不同时间段下不同有效期的门票的不同价格和库存。具体信息请参见skus字段描述。</SPAN>
# <UL>
# </UL>
class TicketItemUpdateRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.ticket.item.update"
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">需要更新的门票商品标识（只支持门票二期商品）</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">门票商品挂载到的产品<br> 通过taobao.products.search获取产品信息，并且对应产品必须是小二确认的达尔文体系产品。</SPAN>
        # <UL>
        # <LI>
        # <SPAN style="color:DarkRed; font-size:18px; font-family:'Times New Roman',Georgia,Serif;">Type</SPAN>: <SPAN style="color:DarkMagenta; font-size:16px; font-family:'Times New Roman','宋体',Georgia,Serif;">Number</SPAN>
        # </LI>
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">需要删除的字段列表</SPAN>
        # <UL>
        # <LI>
