...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">替换一张图片，只替换图片数据，图片名称，图片分类等保持不变。</SPAN>
# <UL>
# </UL>
class PictureReplaceRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.picture.replace"
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">要替换的图片的id，必须大于0</SPAN>
        # <UL>
        # <LI>
