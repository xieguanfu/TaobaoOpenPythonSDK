...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">卖家拒绝退款</SPAN>
# <UL>
# </UL>
class MallEaiOrderRefundRefuseRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "tmall.eai.order.refund.refuse"
