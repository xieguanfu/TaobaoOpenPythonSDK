...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">查询B商家被授权品牌列表、类目列表和 c 商家新品类目列表</SPAN>
# <UL>
# </UL>
class ItemcatsAuthorizeGetRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.itemcats.authorize.get"
