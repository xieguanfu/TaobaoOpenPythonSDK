...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">查询集分宝发放详情，发放API是alipay.point.order.add。请先熟悉发放API的流程。</SPAN>
# <UL>
# </UL>
class LipayPointOrderGetRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "alipay.point.order.get"
