...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">取得一个推广组的所有关键词</SPAN>
# <UL>
# </UL>
class SimbaKeywordsbyadgroupidGetRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.simba.keywordsbyadgroupid.get"
