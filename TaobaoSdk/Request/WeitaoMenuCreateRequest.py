...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">创建菜单</SPAN>
# <UL>
# </UL>
class WeitaoMenuCreateRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.weitao.menu.create"
