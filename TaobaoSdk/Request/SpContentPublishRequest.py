...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">内容发布接口，能够新增或更新内容到建站平台的内容服务</SPAN>
# <UL>
# </UL>
class SpContentPublishRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.sp.content.publish"
