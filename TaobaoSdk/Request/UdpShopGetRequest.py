...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">店铺指标查询</SPAN>
# <UL>
# </UL>
class UdpShopGetRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.udp.shop.get"
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">地区ID(参阅地区编号)</SPAN>
        # <UL>
        # <LI>
