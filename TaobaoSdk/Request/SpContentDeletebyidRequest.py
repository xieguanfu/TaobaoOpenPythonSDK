...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">按主键删除内容</SPAN>
# <UL>
# </UL>
class SpContentDeletebyidRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.sp.content.deletebyid"
