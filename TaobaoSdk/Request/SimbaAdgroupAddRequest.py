...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">创建一个推广组</SPAN>
# <UL>
# </UL>
class SimbaAdgroupAddRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.simba.adgroup.add"
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">创意图片地址，必须是商品的图片之一</SPAN>
        # <UL>
        # <LI>
