...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">政策全量增加,会删除政策中字段source值为TOP的记录，并且把新增的记录插入，传入文件大小限制在5M(一般10w条记录不会超过5M),每半小时只允许调用一次</SPAN>
# <UL>
# </UL>
class JipiaoPoliciesFulladdRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.jipiao.policies.fulladd"
