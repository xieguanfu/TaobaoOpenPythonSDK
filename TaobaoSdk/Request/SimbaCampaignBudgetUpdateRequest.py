...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">更新一个推广计划的日限额</SPAN>
# <UL>
# </UL>
class SimbaCampaignBudgetUpdateRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.simba.campaign.budget.update"
        ...
        ## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">是否平滑消耗：false-否，true-是</SPAN>
        # <UL>
        # <LI>
