...
## @brief <SPAN style="font-size:16px; font-family:'宋体','Times New Roman',Georgia,Serif;">根据主键查找内容的详细信息</SPAN>
# <UL>
# </UL>
class SpContentGetdetailbyidRequest(object):
    def __init__(self):
        ...
        # </LI>
        # </UL>
        self.method = "taobao.sp.content.getdetailbyid"
